...
public class PS3TMAPI
{
  ...
  private static void VersionComponents(
    ulong version,
    out byte major,
    out byte minor,
    out byte fix)
  ...
  public static void SDKVersionComponents(
    ulong sdkVersion,
    out byte major,
    out byte minor,
    out byte fix)
  ...
  public static void CPVersionComponents(
    ulong cpVersion,
    out byte major,
    out byte minor,
    out byte fix)
  ...
  private static extern PS3TMAPI.SNRESULT TranslateErrorX86(
    PS3TMAPI.SNRESULT res,
    out IntPtr message);

  [DllImport("PS3TMAPIX64.dll", EntryPoint = "SNPS3TranslateError", CallingConvention = CallingConvention.Cdecl)]
  private static extern PS3TMAPI.SNRESULT TranslateErrorX64(
    PS3TMAPI.SNRESULT res,
    out IntPtr message);

  public static PS3TMAPI.SNRESULT TranslateError(
    PS3TMAPI.SNRESULT errorCode,
    out string message)
  {
    IntPtr message1;
  ...
  private static extern PS3TMAPI.SNRESULT GetErrorQualifierX86(
    out uint qualifier,
    out IntPtr message);

  [DllImport("PS3TMAPIX64.dll", EntryPoint = "SNPS3GetErrorQualifier", CallingConvention = CallingConvention.Cdecl)]
  private static extern PS3TMAPI.SNRESULT GetErrorQualifierX64(
    out uint qualifier,
    out IntPtr message);
  ...
  private static extern PS3TMAPI.SNRESULT EnumerateTargetsX86(
    PS3TMAPI.EnumerateTargetsCallback callback);

  [DllImport("PS3TMAPIX64.dll", EntryPoint = "SNPS3EnumerateTargets", CallingConvention = CallingConvention.Cdecl)]
  private static extern PS3TMAPI.SNRESULT EnumerateTargetsX64(
    PS3TMAPI.EnumerateTargetsCallback callback);

  public static PS3TMAPI.SNRESULT EnumerateTargets(
    PS3TMAPI.EnumerateTargetsCallback callback)
  {
    if (!PS3TMAPI.Is32Bit())
  ...
  private static extern PS3TMAPI.SNRESULT EnumerateTargetsExX86(
    PS3TMAPI.EnumerateTargetsExCallbackPriv callback,
    IntPtr unused);

  [DllImport("PS3TMAPIX64.dll", EntryPoint = "SNPS3EnumerateTargetsEx", CallingConvention = CallingConvention.Cdecl)]
  private static extern PS3TMAPI.SNRESULT EnumerateTargetsExX64(
    PS3TMAPI.EnumerateTargetsExCallbackPriv callback,
    IntPtr unused);

  public static PS3TMAPI.SNRESULT EnumerateTargetsEx(
    PS3TMAPI.EnumerateTargetsExCallback callback,
    ref object userData)
  {
    if (callback == null)
  ...
  private static extern PS3TMAPI.SNRESULT ResetExX86(
    int target,
    ulong boot,
    ulong bootMask,
    ulong reset,
  ...
  private static extern PS3TMAPI.SNRESULT ResetExX64(
    int target,
    ulong boot,
    ulong bootMask,
    ulong reset,
  ...
  public static PS3TMAPI.SNRESULT ResetEx(
    int target,
  ...
  private static extern PS3TMAPI.SNRESULT GetResetParametersX86(
    int target,
    out ulong boot,
    out ulong bootMask,
    out ulong reset,
  ...
  private static extern PS3TMAPI.SNRESULT GetResetParametersX64(
    int target,
    out ulong boot,
    out ulong bootMask,
    out ulong reset,
  ...
  public static PS3TMAPI.SNRESULT GetResetParameters(
    int target,
    out PS3TMAPI.BootParameter bootParameter,
    out PS3TMAPI.BootParameterMask bootMask,
    out PS3TMAPI.ResetParameter resetParameter,
    out PS3TMAPI.ResetParameterMask resetMask,
    out PS3TMAPI.SystemParameter systemParameter,
    out PS3TMAPI.SystemParameterMask systemMask)
  {
    ulong boot;
    ulong bootMask1;
    ulong reset;
  ...
  private static extern PS3TMAPI.SNRESULT SetBootParameterX86(
    int target,
    ulong boot,
    ulong bootMask);

  [DllImport("PS3TMAPIX64.dll", EntryPoint = "SNPS3SetBootParameter", CallingConvention = CallingConvention.Cdecl)]
  private static extern PS3TMAPI.SNRESULT SetBootParameterX64(
    int target,
    ulong boot,
    ulong bootMask);

  public static PS3TMAPI.SNRESULT SetBootParameter(
    int target,
    PS3TMAPI.BootParameter bootParameter,
    PS3TMAPI.BootParameterMask bootMask)
  {
  ...
  private static extern PS3TMAPI.SNRESULT GetCurrentBootParameterX86(
    int target,
    out ulong boot);

  [DllImport("PS3TMAPIX64.dll", EntryPoint = "SNPS3GetCurrentBootParameter", CallingConvention = CallingConvention.Cdecl)]
  private static extern PS3TMAPI.SNRESULT GetCurrentBootParameterX64(
    int target,
    out ulong boot);

  public static PS3TMAPI.SNRESULT GetCurrentBootParameter(
    int target,
    out PS3TMAPI.BootParameter bootParameter)
  {
    ulong boot;
  ...
  private static extern PS3TMAPI.SNRESULT SetSystemParameterX86(
    int target,
    ulong system,
    ulong systemMask);

  [DllImport("PS3TMAPIX64.dll", EntryPoint = "SNPS3SetSystemParameter", CallingConvention = CallingConvention.Cdecl)]
  private static extern PS3TMAPI.SNRESULT SetSystemParameterX64(
    int target,
    ulong system,
    ulong systemMask);

  public static PS3TMAPI.SNRESULT SetSystemParameter(
    int target,
    PS3TMAPI.SystemParameter systemParameter,
    PS3TMAPI.SystemParameterMask systemMask)
  {
  ...
  private static extern PS3TMAPI.SNRESULT ListTargetTypesX86(
    ref uint size,
    IntPtr targetTypes);

  [DllImport("PS3TMAPIX64.dll", EntryPoint = "SNPS3ListTargetTypes", CallingConvention = CallingConvention.Cdecl)]
  private static extern PS3TMAPI.SNRESULT ListTargetTypesX64(
    ref uint size,
    IntPtr targetTypes);
  ...
  public static PS3TMAPI.SNRESULT ListTargetTypes(out PS3TMAPI.TargetType[] targetTypes)
  {
    ...
    if (PS3TMAPI.FAILED(res2))
      return res2;
    targetTypes = new PS3TMAPI.TargetType[(IntPtr) size];
    IntPtr utf8Ptr = scopedGlobalHeapPtr.Get();
    for (uint index = 0; index < size; ++index)
    {
      targetTypes[(IntPtr) index].Type = PS3TMAPI.Utf8ToString(utf8Ptr, 64U);
      utf8Ptr = new IntPtr(utf8Ptr.ToInt64() + 64L);
      targetTypes[(IntPtr) index].Description = PS3TMAPI.Utf8ToString(utf8Ptr, 256U);
  ...
  private static extern PS3TMAPI.SNRESULT AddTargetX86(
    IntPtr name,
    IntPtr type,
    int connParamsSize,
    IntPtr connectParams,
    out int target);

  [DllImport("PS3TMAPIX64.dll", EntryPoint = "SNPS3AddTarget", CallingConvention = CallingConvention.Cdecl)]
  private static extern PS3TMAPI.SNRESULT AddTargetX64(
    IntPtr name,
    IntPtr type,
    int connParamsSize,
    IntPtr connectParams,
  ...
  public static PS3TMAPI.SNRESULT AddTarget(
    string name,
    string targetType,
  ...
  private static extern PS3TMAPI.SNRESULT RegisterServerEventHandlerX86(
    PS3TMAPI.HandleEventCallbackPriv callback,
    IntPtr userData);

  [DllImport("PS3TMAPIX64.dll", EntryPoint = "SNPS3RegisterServerEventHandler", CallingConvention = CallingConvention.Cdecl)]
  private static extern PS3TMAPI.SNRESULT RegisterServerEventHandlerX64(
    PS3TMAPI.HandleEventCallbackPriv callback,
    IntPtr userData);

  public static PS3TMAPI.SNRESULT RegisterServerEventHandler(
    PS3TMAPI.ServerEventCallback callback,
    ref object userData)
  {
    if (callback == null)
      return PS3TMAPI.SNRESULT.SN_E_BAD_PARAM;
  ...
  private static void MarshalServerEvent(
    int target,
    uint param,
  ...
  private static extern PS3TMAPI.SNRESULT SetConnectionInfoX86(
    int target,
    IntPtr connectProperties);

  [DllImport("PS3TMAPIX64.dll", EntryPoint = "SNPS3SetConnectionInfo", CallingConvention = CallingConvention.Cdecl)]
  private static extern PS3TMAPI.SNRESULT SetConnectionInfoX64(
    int target,
    IntPtr connectProperties);

  public static PS3TMAPI.SNRESULT SetConnectionInfo(
    int target,
    PS3TMAPI.TCPIPConnectProperties connectProperties)
  {
  ...
  private static extern PS3TMAPI.SNRESULT ConnectExX86(
    int target,
    string application,
    bool bForceFlag);

  [DllImport("PS3TMAPIX64.dll", EntryPoint = "SNPS3ConnectEx", CallingConvention = CallingConvention.Cdecl)]
  private static extern PS3TMAPI.SNRESULT ConnectExX64(
    int target,
    string application,
    bool bForceFlag);

  public static PS3TMAPI.SNRESULT ConnectEx(
    int target,
    string application,
    bool bForceFlag)
  {
  ...
  private static extern PS3TMAPI.SNRESULT GetSystemInfoX86(
    int target,
    uint reserved,
    out uint mask,
    out PS3TMAPI.SystemInfo info);

  [DllImport("PS3TMAPIX64.dll", EntryPoint = "SNPS3GetSystemInfo", CallingConvention = CallingConvention.Cdecl)]
  private static extern PS3TMAPI.SNRESULT GetSystemInfoX64(
    int target,
    uint reserved,
    out uint mask,
    out PS3TMAPI.SystemInfo info);

  public static PS3TMAPI.SNRESULT GetSystemInfo(
    int target,
    out PS3TMAPI.SystemInfoFlag mask,
    out PS3TMAPI.SystemInfo systemInfo)
  {
  ...
  private static extern PS3TMAPI.SNRESULT GetExtraLoadFlagsX86(
    int target,
    out ulong extraLoadFlags);

  [DllImport("PS3TMAPIX64.dll", EntryPoint = "SNPS3GetExtraLoadFlags", CallingConvention = CallingConvention.Cdecl)]
  private static extern PS3TMAPI.SNRESULT GetExtraLoadFlagsX64(
    int target,
    out ulong extraLoadFlags);

  public static PS3TMAPI.SNRESULT GetExtraLoadFlags(
    int target,
    out PS3TMAPI.ExtraLoadFlag extraLoadFlags)
  {
  ...
  private static extern PS3TMAPI.SNRESULT SetExtraLoadFlagsX86(
    int target,
    ulong extraLoadFlags,
    ulong mask);

  [DllImport("PS3TMAPIX64.dll", EntryPoint = "SNPS3SetExtraLoadFlags", CallingConvention = CallingConvention.Cdecl)]
  private static extern PS3TMAPI.SNRESULT SetExtraLoadFlagsX64(
    int target,
    ulong extraLoadFlags,
    ulong mask);

  public static PS3TMAPI.SNRESULT SetExtraLoadFlags(
    int target,
    PS3TMAPI.ExtraLoadFlag extraLoadFlags,
    PS3TMAPI.ExtraLoadFlagMask mask)
  {
    if (!PS3TMAPI.Is32Bit())
  ...
  private static extern PS3TMAPI.SNRESULT SetTimeoutsX86(
    int target,
    uint numTimeouts,
    PS3TMAPI.TimeoutType[] timeoutIds,
    uint[] timeoutValues);

  [DllImport("PS3TMAPIX64.dll", EntryPoint = "SNPS3SetTimeouts", CallingConvention = CallingConvention.Cdecl)]
  private static extern PS3TMAPI.SNRESULT SetTimeoutsX64(
    int target,
    uint numTimeouts,
    PS3TMAPI.TimeoutType[] timeoutIds,
    uint[] timeoutValues);

  public static PS3TMAPI.SNRESULT SetTimeouts(
    int target,
    PS3TMAPI.TimeoutType[] timeoutTypes,
    uint[] timeoutValues)
  {
  ...
  private static extern PS3TMAPI.SNRESULT GetTimeoutsX86(
    int target,
    out uint numTimeouts,
    PS3TMAPI.TimeoutType[] timeoutIds,
    uint[] timeoutValues);

  [DllImport("PS3TMAPIX64.dll", EntryPoint = "SNPS3GetTimeouts", CallingConvention = CallingConvention.Cdecl)]
  private static extern PS3TMAPI.SNRESULT GetTimeoutsX64(
    int target,
    out uint numTimeouts,
    PS3TMAPI.TimeoutType[] timeoutIds,
    uint[] timeoutValues);

  public static PS3TMAPI.SNRESULT GetTimeouts(
    int target,
    out PS3TMAPI.TimeoutType[] timeoutTypes,
    out uint[] timeoutValues)
  {
    ...
    if (PS3TMAPI.FAILED(res))
      return res;
    timeoutTypes = new PS3TMAPI.TimeoutType[(IntPtr) numTimeouts];
    timeoutValues = new uint[(IntPtr) numTimeouts];
    if (!PS3TMAPI.Is32Bit())
  ...
  private static extern PS3TMAPI.SNRESULT ListTtyStreamsX86(
    int target,
    ref uint size,
    IntPtr streamArray);

  [DllImport("PS3TMAPIX64.dll", EntryPoint = "SNPS3ListTTYStreams", CallingConvention = CallingConvention.Cdecl)]
  private static extern PS3TMAPI.SNRESULT ListTtyStreamsX64(
    int target,
    ref uint size,
    IntPtr streamArray);

  public static PS3TMAPI.SNRESULT ListTTYStreams(
    int target,
    out PS3TMAPI.TTYStream[] streamArray)
  {
    ...
    streamArray = new PS3TMAPI.TTYStream[(IntPtr) size];
    for (uint index = 0; index < size; ++index)
      unmanagedBuf = PS3TMAPI.ReadDataFromUnmanagedIncPtr<PS3TMAPI.TTYStream>(unmanagedBuf, ref streamArray[(IntPtr) index]);
    return res2;
  }

  [DllImport("PS3TMAPI.dll", EntryPoint = "SNPS3RegisterTTYEventHandler", CallingConvention = CallingConvention.Cdecl)]
  private static extern PS3TMAPI.SNRESULT RegisterTtyEventHandlerX86(
    int target,
    uint streamIndex,
    PS3TMAPI.HandleEventCallbackPriv callback,
    IntPtr userData);
  ...
  private static extern PS3TMAPI.SNRESULT RegisterTtyEventHandlerX64(
    int target,
    uint streamIndex,
    PS3TMAPI.HandleEventCallbackPriv callback,
    IntPtr userData);

  public static PS3TMAPI.SNRESULT RegisterTTYEventHandler(
    int target,
    uint streamID,
    PS3TMAPI.TTYCallback callback,
    ref object userData)
  {
    return PS3TMAPI.RegisterTTYEventHandlerHelper(target, streamID, (object) callback, ref userData);
  }

  public static PS3TMAPI.SNRESULT RegisterTTYEventHandlerRaw(
    int target,
    uint streamID,
    PS3TMAPI.TTYCallbackRaw callback,
    ref object userData)
  {
    return PS3TMAPI.RegisterTTYEventHandlerHelper(target, streamID, (object) callback, ref userData);
  }

  private static PS3TMAPI.SNRESULT RegisterTTYEventHandlerHelper(
    int target,
    uint streamID,
    object callback,
    ref object userData)
  ...
  [DllImport("PS3TMAPI.dll", EntryPoint = "SNPS3SendTTY", CallingConvention = CallingConvention.Cdecl)]
  private static extern PS3TMAPI.SNRESULT SendTTYRawX86(
    int target,
    uint index,
    byte[] text);

  [DllImport("PS3TMAPIX64.dll", EntryPoint = "SNPS3SendTTY", CallingConvention = CallingConvention.Cdecl)]
  private static extern PS3TMAPI.SNRESULT SendTTYRawX64(
    int target,
    uint index,
    byte[] text);
  ...
  private static void MarshalTTYEvent(
    int target,
    uint param,
    PS3TMAPI.SNRESULT result,
    uint length,
  ...
  private static extern PS3TMAPI.SNRESULT GetStatusX86(
    int target,
  ...
  private static extern PS3TMAPI.SNRESULT GetStatusX64(
    int target,
    PS3TMAPI.UnitType unit,
    out long status,
    IntPtr reasonCode);

  public static PS3TMAPI.SNRESULT GetStatus(
    int target,
    PS3TMAPI.UnitType unit,
    out PS3TMAPI.UnitStatus unitStatus)
  {
    long status;
  ...
  private static extern PS3TMAPI.SNRESULT ProcessLoadX86(
    int target,
    uint priority,
    IntPtr fileName,
    int argCount,
  ...
  private static extern PS3TMAPI.SNRESULT ProcessLoadX64(
    int target,
    uint priority,
    IntPtr fileName,
    int argCount,
  ...
  public static PS3TMAPI.SNRESULT ProcessLoad(
    int target,
    uint priority,
    string fileName,
    string[] argv,
  ...
  public static PS3TMAPI.SNRESULT GetProcessList(int target, out uint[] processIDs)
  {
    ...
    if (PS3TMAPI.FAILED(res2))
      return res2;
    IntPtr unmanagedBuf = scopedGlobalHeapPtr.Get();
    processIDs = new uint[(IntPtr) count];
    for (uint index = 0; index < count; ++index)
      unmanagedBuf = PS3TMAPI.ReadDataFromUnmanagedIncPtr<uint>(unmanagedBuf, ref processIDs[(IntPtr) index]);
    return res2;
  }

  [DllImport("PS3TMAPI.dll", EntryPoint = "SNPS3UserProcessList", CallingConvention = CallingConvention.Cdecl)]
  private static extern PS3TMAPI.SNRESULT GetUserProcessListX86(
    int target,
    ref uint count,
    IntPtr processIdArray);

  [DllImport("PS3TMAPIX64.dll", EntryPoint = "SNPS3UserProcessList", CallingConvention = CallingConvention.Cdecl)]
  private static extern PS3TMAPI.SNRESULT GetUserProcessListX64(
    int target,
    ref uint count,
    IntPtr processIdArray);
  ...
  private static extern PS3TMAPI.SNRESULT TerminateGameProcessX86(
    int target,
    uint processId,
    uint timeout);

  [DllImport("PS3TMAPIX64.dll", EntryPoint = "SNPS3TerminateGameProcess", CallingConvention = CallingConvention.Cdecl)]
  private static extern PS3TMAPI.SNRESULT TerminateGameProcessX64(
    int target,
    uint processId,
    uint timeout);

  public static PS3TMAPI.SNRESULT TerminateGameProcess(
    int target,
    uint processID,
    uint timeout)
  {
  ...
  private static extern PS3TMAPI.SNRESULT GetThreadListX86(
    int target,
    uint processId,
    ref uint numPPUThreads,
    ulong[] ppuThreadIds,
    ref uint numSPUThreadGroups,
    ulong[] spuThreadGroupIds);

  [DllImport("PS3TMAPIX64.dll", EntryPoint = "SNPS3ThreadList", CallingConvention = CallingConvention.Cdecl)]
  private static extern PS3TMAPI.SNRESULT GetThreadListX64(
    int target,
    uint processId,
    ref uint numPPUThreads,
    ulong[] ppuThreadIds,
  ...
  public static PS3TMAPI.SNRESULT GetThreadList(
    int target,
    uint processID,
    out ulong[] ppuThreadIDs,
    out ulong[] spuThreadGroupIDs)
  {
    ...
    if (PS3TMAPI.FAILED(res))
      return res;
    ppuThreadIDs = new ulong[(IntPtr) numPPUThreads];
    spuThreadGroupIDs = new ulong[(IntPtr) numSPUThreadGroups];
  ...
  private static extern PS3TMAPI.SNRESULT ThreadStopX86(
    int target,
    PS3TMAPI.UnitType unit,
    uint processId,
    ulong threadId);
  ...
  private static extern PS3TMAPI.SNRESULT ThreadStopX64(
    int target,
    PS3TMAPI.UnitType unit,
    uint processId,
    ulong threadId);

  public static PS3TMAPI.SNRESULT ThreadStop(
    int target,
    PS3TMAPI.UnitType unit,
    uint processID,
    ulong threadID)
  ...
  private static extern PS3TMAPI.SNRESULT ThreadContinueX86(
    int target,
    PS3TMAPI.UnitType unit,
    uint processId,
    ulong threadId);
  ...
  private static extern PS3TMAPI.SNRESULT ThreadContinueX64(
    int target,
    PS3TMAPI.UnitType unit,
    uint processId,
    ulong threadId);

  public static PS3TMAPI.SNRESULT ThreadContinue(
    int target,
    PS3TMAPI.UnitType unit,
    uint processID,
    ulong threadID)
  ...
  private static extern PS3TMAPI.SNRESULT ThreadGetRegistersX86(
    int target,
    PS3TMAPI.UnitType unit,
    uint processId,
    ulong threadId,
  ...
  private static extern PS3TMAPI.SNRESULT ThreadGetRegistersX64(
    int target,
    PS3TMAPI.UnitType unit,
    uint processId,
    ulong threadId,
  ...
  public static PS3TMAPI.SNRESULT ThreadGetRegisters(
    int target,
    PS3TMAPI.UnitType unit,
    uint processID,
    ulong threadID,
    uint[] registerNums,
    out ulong[] registerValues)
  {
  ...
  private static extern PS3TMAPI.SNRESULT ThreadSetRegistersX86(
    int target,
    PS3TMAPI.UnitType unit,
    uint processId,
    ulong threadId,
  ...
  private static extern PS3TMAPI.SNRESULT ThreadSetRegistersX64(
    int target,
    PS3TMAPI.UnitType unit,
    uint processId,
    ulong threadId,
  ...
  public static PS3TMAPI.SNRESULT ThreadSetRegisters(
    int target,
    PS3TMAPI.UnitType unit,
    uint processID,
    ulong threadID,
  ...
  private static void ProcessInfoMarshalHelper(
    IntPtr unmanagedBuf,
    ref PS3TMAPI.ProcessInfo processInfo)
  {
    uint storage = 0;
    ...
    processInfo.ThreadIDs = new ulong[(IntPtr) num];
  ...
  private static extern PS3TMAPI.SNRESULT GetProcessInfoX86(
    int target,
    uint processId,
    ref uint bufferSize,
    IntPtr processInfo);
  ...
  private static extern PS3TMAPI.SNRESULT GetProcessInfoX64(
    int target,
    uint processId,
    ref uint bufferSize,
    IntPtr processInfo);

  public static PS3TMAPI.SNRESULT GetProcessInfo(
    int target,
    uint processID,
  ...
  private static extern PS3TMAPI.SNRESULT GetProcessInfoExX86(
    int target,
    uint processId,
    ref uint bufferSize,
    IntPtr processInfo,
    out PS3TMAPI.ExtraProcessInfo extraProcessInfo);

  [DllImport("PS3TMAPIX64.dll", EntryPoint = "SNPS3ProcessInfoEx", CallingConvention = CallingConvention.Cdecl)]
  private static extern PS3TMAPI.SNRESULT GetProcessInfoExX64(
    int target,
    uint processId,
    ref uint bufferSize,
    IntPtr processInfo,
  ...
  public static PS3TMAPI.SNRESULT GetProcessInfoEx(
    int target,
    uint processID,
    out PS3TMAPI.ProcessInfo processInfo,
    out PS3TMAPI.ExtraProcessInfo extraProcessInfo)
  ...
  private static extern PS3TMAPI.SNRESULT GetProcessInfoEx2X86(
    int target,
    uint processId,
    ref uint bufferSize,
    IntPtr processInfo,
    out PS3TMAPI.ExtraProcessInfo extraProcessInfo,
    out PS3TMAPI.ProcessLoadInfo processLoadInfo);

  [DllImport("PS3TMAPIX64.dll", EntryPoint = "SNPS3ProcessInfoEx2", CallingConvention = CallingConvention.Cdecl)]
  private static extern PS3TMAPI.SNRESULT GetProcessInfoEx2X64(
    int target,
    uint processId,
    ref uint bufferSize,
    IntPtr processInfo,
  ...
  public static PS3TMAPI.SNRESULT GetProcessInfoEx2(
    int target,
    uint processID,
    out PS3TMAPI.ProcessInfo processInfo,
    out PS3TMAPI.ExtraProcessInfo extraProcessInfo,
  ...
  private static extern PS3TMAPI.SNRESULT GetModuleListX86(
    int target,
    uint processId,
    ref uint numModules,
    uint[] moduleList);
  ...
  private static extern PS3TMAPI.SNRESULT GetModuleListX64(
    int target,
    uint processId,
    ref uint numModules,
    uint[] moduleList);

  public static PS3TMAPI.SNRESULT GetModuleList(
    int target,
    uint processID,
    out uint[] modules)
  {
    ...
    if (PS3TMAPI.FAILED(res))
      return res;
    modules = new uint[(IntPtr) numModules];
  ...
  private static IntPtr ModuleInfoHdrMarshalHelper(
    IntPtr unmanagedBuf,
    ref PS3TMAPI.ModuleInfoHdr moduleInfoHdr)
  {
  ...
  private static extern PS3TMAPI.SNRESULT GetModuleInfoX86(
    int target,
    uint processId,
    uint moduleId,
  ...
  private static extern PS3TMAPI.SNRESULT GetModuleInfoX64(
    int target,
    uint processId,
    uint moduleId,
    ref ulong bufferSize,
  ...
  public static PS3TMAPI.SNRESULT GetModuleInfo(
    int target,
    uint processID,
    uint moduleID,
    out PS3TMAPI.ModuleInfo moduleInfo)
  {
    ...
    moduleInfo.Segments = new PS3TMAPI.PRXSegment[(IntPtr) moduleInfo.Hdr.NumSegments];
  ...
  private static extern PS3TMAPI.SNRESULT GetModuleInfoExX86(
    int target,
    uint processId,
    uint moduleId,
    ref ulong bufferSize,
    IntPtr moduleInfoEx,
    out IntPtr mselfInfo,
    out PS3TMAPI.ExtraModuleInfo extraModuleInfo);

  [DllImport("PS3TMAPIX64.dll", EntryPoint = "SNPS3GetModuleInfoEx", CallingConvention = CallingConvention.Cdecl)]
  private static extern PS3TMAPI.SNRESULT GetModuleInfoExX64(
    int target,
    uint processId,
    uint moduleId,
    ref ulong bufferSize,
  ...
  public static PS3TMAPI.SNRESULT GetModuleInfoEx(
    int target,
    uint processID,
    uint moduleID,
    out PS3TMAPI.ModuleInfoEx moduleInfoEx,
    out PS3TMAPI.MSELFInfo mselfInfo,
    out PS3TMAPI.ExtraModuleInfo extraModuleInfo)
  {
    ...
    moduleInfoEx.Segments = new PS3TMAPI.PRXSegmentEx[(IntPtr) moduleInfoEx.Hdr.NumSegments];
  ...
  private static extern PS3TMAPI.SNRESULT GetThreadInfoX86(
    int target,
    PS3TMAPI.UnitType unit,
    uint processId,
    ulong threadId,
  ...
  private static extern PS3TMAPI.SNRESULT GetThreadInfoX64(
    int target,
    PS3TMAPI.UnitType unit,
    uint processId,
    ulong threadId,
  ...
  public static PS3TMAPI.SNRESULT GetPPUThreadInfo(
    int target,
    uint processID,
    ulong threadID,
    out PS3TMAPI.PPUThreadInfo threadInfo)
  {
  ...
  private static extern PS3TMAPI.SNRESULT GetPPUThreadInfoExX86(
    int target,
    uint processId,
    ulong threadId,
    ref uint bufferSize,
  ...
  private static extern PS3TMAPI.SNRESULT GetPPUThreadInfoExX64(
    int target,
    uint processId,
    ulong threadId,
    ref uint bufferSize,
  ...
  public static PS3TMAPI.SNRESULT GetPPUThreadInfoEx(
    int target,
    uint processID,
    ulong threadID,
    out PS3TMAPI.PPUThreadInfoEx threadInfoEx)
  {
  ...
  public static PS3TMAPI.SNRESULT GetSPUThreadInfo(
    int target,
    uint processID,
    ulong threadID,
    out PS3TMAPI.SPUThreadInfo threadInfo)
  {
  ...
  private static extern PS3TMAPI.SNRESULT SetDefaultPPUThreadStackSizeX86(
    int target,
    PS3TMAPI.ELFStackSize size);

  [DllImport("PS3TMAPIX64.dll", EntryPoint = "SNPS3SetDefaultPPUThreadStackSize", CallingConvention = CallingConvention.Cdecl)]
  private static extern PS3TMAPI.SNRESULT SetDefaultPPUThreadStackSizeX64(
    int target,
    PS3TMAPI.ELFStackSize size);

  public static PS3TMAPI.SNRESULT SetDefaultPPUThreadStackSize(
    int target,
    PS3TMAPI.ELFStackSize stackSize)
  {
    if (!PS3TMAPI.Is32Bit())
  ...
  private static extern PS3TMAPI.SNRESULT GetDefaultPPUThreadStackSizeX86(
    int target,
    out PS3TMAPI.ELFStackSize size);

  [DllImport("PS3TMAPIX64.dll", EntryPoint = "SNPS3GetDefaultPPUThreadStackSize", CallingConvention = CallingConvention.Cdecl)]
  private static extern PS3TMAPI.SNRESULT GetDefaultPPUThreadStackSizeX64(
    int target,
    out PS3TMAPI.ELFStackSize size);

  public static PS3TMAPI.SNRESULT GetDefaultPPUThreadStackSize(
    int target,
    out PS3TMAPI.ELFStackSize stackSize)
  {
    if (!PS3TMAPI.Is32Bit())
  ...
  private static extern PS3TMAPI.SNRESULT SetSPULoopPointX86(
    int target,
    uint processId,
    ulong threadId,
    uint address,
  ...
  private static extern PS3TMAPI.SNRESULT SetSPULoopPointX64(
    int target,
    uint processId,
    ulong threadId,
    uint address,
  ...
  public static PS3TMAPI.SNRESULT SetSPULoopPoint(
    int target,
    uint processID,
    ulong threadID,
    uint address,
  ...
  private static extern PS3TMAPI.SNRESULT ClearSPULoopPointX86(
    int target,
    uint processId,
    ulong threadId,
    uint address,
  ...
  private static extern PS3TMAPI.SNRESULT ClearSPULoopPointX64(
    int target,
    uint processId,
    ulong threadId,
    uint address,
  ...
  public static PS3TMAPI.SNRESULT ClearSPULoopPoint(
    int target,
    uint processID,
    ulong threadID,
    uint address,
  ...
  private static extern PS3TMAPI.SNRESULT SetBreakPointX86(
    int target,
    uint unit,
    uint processId,
    ulong threadId,
  ...
  private static extern PS3TMAPI.SNRESULT SetBreakPointX64(
    int target,
    uint unit,
    uint processId,
    ulong threadId,
  ...
  public static PS3TMAPI.SNRESULT SetBreakPoint(
    int target,
    PS3TMAPI.UnitType unit,
    uint processID,
    ulong threadID,
  ...
  private static extern PS3TMAPI.SNRESULT ClearBreakPointX86(
    int target,
    uint unit,
    uint processId,
    ulong threadId,
  ...
  private static extern PS3TMAPI.SNRESULT ClearBreakPointX64(
    int target,
    uint unit,
    uint processId,
    ulong threadId,
  ...
  public static PS3TMAPI.SNRESULT ClearBreakPoint(
    int target,
    PS3TMAPI.UnitType unit,
    uint processID,
    ulong threadID,
  ...
  private static extern PS3TMAPI.SNRESULT GetBreakPointsX86(
    int target,
    uint unit,
    uint processId,
    ulong threadId,
    out uint numBreakpoints,
    ulong[] addresses);

  [DllImport("PS3TMAPIX64.dll", EntryPoint = "SNPS3GetBreakPoints", CallingConvention = CallingConvention.Cdecl)]
  private static extern PS3TMAPI.SNRESULT GetBreakPointsX64(
    int target,
    uint unit,
    uint processId,
    ulong threadId,
  ...
  public static PS3TMAPI.SNRESULT GetBreakPoints(
    int target,
    PS3TMAPI.UnitType unit,
    uint processID,
    ulong threadID,
    out ulong[] bpAddresses)
  {
    ...
    if (PS3TMAPI.FAILED(res))
      return res;
    bpAddresses = new ulong[(IntPtr) numBreakpoints];
    if (!PS3TMAPI.Is32Bit())
  ...
  private static extern PS3TMAPI.SNRESULT GetDebugThreadControlInfoX86(
    int target,
    uint processId,
    ref uint bufferSize,
    IntPtr buffer);
  ...
  private static extern PS3TMAPI.SNRESULT GetDebugThreadControlInfoX64(
    int target,
    uint processId,
    ref uint bufferSize,
    IntPtr buffer);

  public static PS3TMAPI.SNRESULT GetDebugThreadControlInfo(
    int target,
    uint processID,
    out PS3TMAPI.DebugThreadControlInfo threadCtrlInfo)
  {
    ...
    threadCtrlInfo.ControlKeywords = new PS3TMAPI.ControlKeywordEntry[(IntPtr) numEntries];
    for (uint index = 0; index < numEntries; ++index)
    {
      num = PS3TMAPI.ReadDataFromUnmanagedIncPtr<uint>(num, ref threadCtrlInfo.ControlKeywords[(IntPtr) index].MatchConditionFlags);
      threadCtrlInfo.ControlKeywords[(IntPtr) index].Keyword = PS3TMAPI.Utf8ToString(num, 128U);
  ...
  private static extern PS3TMAPI.SNRESULT SetDebugThreadControlInfoX86(
    int target,
    uint processId,
    IntPtr threadCtrlInfo,
    out uint maxEntries);

  [DllImport("PS3TMAPIX64.dll", EntryPoint = "SNPS3SetDebugThreadControlInfo", CallingConvention = CallingConvention.Cdecl)]
  private static extern PS3TMAPI.SNRESULT SetDebugThreadControlInfoX64(
    int target,
    uint processId,
    IntPtr threadCtrlInfo,
    out uint maxEntries);

  public static PS3TMAPI.SNRESULT SetDebugThreadControlInfo(
    int target,
    uint processID,
    PS3TMAPI.DebugThreadControlInfo threadCtrlInfo,
    out uint maxEntries)
  {
    PS3TMAPI.DebugThreadControlInfoPriv storage = new PS3TMAPI.DebugThreadControlInfoPriv();
  ...
  private static extern PS3TMAPI.SNRESULT ThreadExceptionCleanX86(
    int target,
    uint processId,
    ulong threadId);

  [DllImport("PS3TMAPIX64.dll", EntryPoint = "SNPS3ThreadExceptionClean", CallingConvention = CallingConvention.Cdecl)]
  private static extern PS3TMAPI.SNRESULT ThreadExceptionCleanX64(
    int target,
    uint processId,
    ulong threadId);

  public static PS3TMAPI.SNRESULT ThreadExceptionClean(
    int target,
    uint processID,
    ulong threadID)
  {
  ...
  private static extern PS3TMAPI.SNRESULT GetRawSPULogicalIdsX86(
    int target,
    uint processId,
    ulong[] logicalIds);

  [DllImport("PS3TMAPIX64.dll", EntryPoint = "SNPS3GetRawSPULogicalIDs", CallingConvention = CallingConvention.Cdecl)]
  private static extern PS3TMAPI.SNRESULT GetRawSPULogicalIdsX64(
    int target,
    uint processId,
    ulong[] logicalIds);

  public static PS3TMAPI.SNRESULT GetRawSPULogicalIDs(
    int target,
    uint processID,
    out ulong[] logicalIDs)
  {
  ...
  private static extern PS3TMAPI.SNRESULT SPUThreadGroupStopX86(
    int target,
    uint processId,
    ulong threadGroupId);

  [DllImport("PS3TMAPIX64.dll", EntryPoint = "SNPS3SPUThreadGroupStop", CallingConvention = CallingConvention.Cdecl)]
  private static extern PS3TMAPI.SNRESULT SPUThreadGroupStopX64(
    int target,
    uint processId,
    ulong threadGroupId);

  public static PS3TMAPI.SNRESULT SPUThreadGroupStop(
    int target,
    uint processID,
    ulong threadGroupID)
  {
  ...
  private static extern PS3TMAPI.SNRESULT SPUThreadGroupContinueX86(
    int target,
    uint processId,
    ulong threadGroupId);

  [DllImport("PS3TMAPIX64.dll", EntryPoint = "SNPS3SPUThreadGroupContinue", CallingConvention = CallingConvention.Cdecl)]
  private static extern PS3TMAPI.SNRESULT SPUThreadGroupContinueX64(
    int target,
    uint processId,
    ulong threadGroupId);

  public static PS3TMAPI.SNRESULT SPUThreadGroupContinue(
    int target,
    uint processID,
    ulong threadGroupID)
  {
  ...
  private static extern PS3TMAPI.SNRESULT GetProcessTreeX86(
    int target,
    ref uint numProcesses,
    IntPtr buffer);

  [DllImport("PS3TMAPIX64.dll", EntryPoint = "SNPS3GetProcessTree", CallingConvention = CallingConvention.Cdecl)]
  private static extern PS3TMAPI.SNRESULT GetProcessTreeX64(
    int target,
    ref uint numProcesses,
    IntPtr buffer);

  public static PS3TMAPI.SNRESULT GetProcessTree(
    int target,
    out PS3TMAPI.ProcessTreeBranch[] processTree)
  {
    ...
    if (PS3TMAPI.FAILED(res2))
      return res2;
    processTree = new PS3TMAPI.ProcessTreeBranch[(IntPtr) numProcesses];
    for (int index1 = 0; (long) index1 < (long) numProcesses; ++index1)
    {
      ...
      processTree[index1].PPUThreadStatuses = new PS3TMAPI.PPUThreadStatus[(IntPtr) structure.NumPpuThreads];
      processTree[index1].SPUThreadGroupStatuses = new PS3TMAPI.SPUThreadGroupStatus[(IntPtr) structure.NumSpuThreadGroups];
  ...
  private static extern PS3TMAPI.SNRESULT GetSPUThreadGroupInfoX86(
    int target,
    uint processId,
    ulong threadGroupId,
    ref uint bufferSize,
  ...
  private static extern PS3TMAPI.SNRESULT GetSPUThreadGroupInfoX64(
    int target,
    uint processId,
    ulong threadGroupId,
    ref uint bufferSize,
  ...
  public static PS3TMAPI.SNRESULT GetSPUThreadGroupInfo(
    int target,
    uint processID,
    ulong threadGroupID,
    out PS3TMAPI.SPUThreadGroupInfo threadGroupInfo)
  {
    ...
    threadGroupInfo.ThreadIDs = new uint[(IntPtr) storage.NumThreads];
  ...
  private static extern PS3TMAPI.SNRESULT GetMemoryCompressedX86(
    int target,
    uint processId,
  ...
  private static extern PS3TMAPI.SNRESULT GetMemoryCompressedX64(
    int target,
    uint processId,
    uint compressionLevel,
    uint address,
  ...
  public static PS3TMAPI.SNRESULT GetMemoryCompressed(
    int target,
    uint processID,
    PS3TMAPI.MemoryCompressionLevel compressionLevel,
    uint address,
    ref byte[] buffer)
  {
    if (!PS3TMAPI.Is32Bit())
  ...
  private static extern PS3TMAPI.SNRESULT GetMemory64CompressedX86(
    int target,
    uint processId,
    uint compressionLevel,
    ulong address,
  ...
  private static extern PS3TMAPI.SNRESULT GetMemory64CompressedX64(
    int target,
    uint processId,
    uint compressionLevel,
    ulong address,
  ...
  public static PS3TMAPI.SNRESULT GetMemory64Compressed(
    int target,
    uint processID,
    PS3TMAPI.MemoryCompressionLevel compressionLevel,
    ulong address,
  ...
  private static extern PS3TMAPI.SNRESULT GetVirtualMemoryInfoX86(
    int target,
    uint processId,
    bool bStatsOnly,
    out uint areaCount,
  ...
  private static extern PS3TMAPI.SNRESULT GetVirtualMemoryInfoX64(
    int target,
    uint processId,
    bool bStatsOnly,
    out uint areaCount,
  ...
  public static PS3TMAPI.SNRESULT GetVirtualMemoryInfo(
    int target,
    uint processID,
    bool bStatsOnly,
    out PS3TMAPI.VirtualMemoryArea[] vmAreas)
  {
    ...
    if (PS3TMAPI.FAILED(res2))
      return res2;
    vmAreas = new PS3TMAPI.VirtualMemoryArea[(IntPtr) areaCount];
  ...
  private static extern PS3TMAPI.SNRESULT GetSyncPrimitiveCountsExX86(
    int target,
    uint processId,
    ref uint bufferSize,
    IntPtr buffer);
  ...
  private static extern PS3TMAPI.SNRESULT GetSyncPrimitiveCountsExX64(
    int target,
    uint processId,
    ref uint bufferSize,
    IntPtr buffer);

  public static PS3TMAPI.SNRESULT GetSyncPrimitiveCounts(
    int target,
    uint processID,
    out PS3TMAPI.SyncPrimitiveCounts primitiveCounts)
  {
  ...
  private static extern PS3TMAPI.SNRESULT GetMutexListX86(
    int target,
    uint processId,
    ref uint numMutexes,
    uint[] mutexList);
  ...
  private static extern PS3TMAPI.SNRESULT GetMutexListX64(
    int target,
    uint processId,
    ref uint numMutexes,
    uint[] mutexList);

  public static PS3TMAPI.SNRESULT GetMutexList(
    int target,
    uint processID,
    out uint[] mutexIDs)
  {
    ...
    if (PS3TMAPI.FAILED(res))
      return res;
    mutexIDs = new uint[(IntPtr) numMutexes];
  ...
  private static extern PS3TMAPI.SNRESULT GetMutexInfoX86(
    int target,
    uint processId,
    uint mutexId,
    ref uint bufferSize,
  ...
  private static extern PS3TMAPI.SNRESULT GetMutexInfoX64(
    int target,
    uint processId,
    uint mutexId,
    ref uint bufferSize,
  ...
  public static PS3TMAPI.SNRESULT GetMutexInfo(
    int target,
    uint processID,
    uint mutexID,
    out PS3TMAPI.MutexInfo mutexInfo)
  {
    ...
    mutexInfo.WaitingThreads = new ulong[(IntPtr) storage];
  ...
  private static extern PS3TMAPI.SNRESULT GetLightWeightMutexListX86(
    int target,
    uint processId,
    ref uint numLWMutexes,
    uint[] lwMutexList);

  [DllImport("PS3TMAPIX64.dll", EntryPoint = "SNPS3GetLightWeightMutexList", CallingConvention = CallingConvention.Cdecl)]
  private static extern PS3TMAPI.SNRESULT GetLightWeightMutexListX64(
    int target,
    uint processId,
    ref uint numLWMutexes,
    uint[] lwMutexList);

  public static PS3TMAPI.SNRESULT GetLightWeightMutexList(
    int target,
    uint processID,
    out uint[] lwMutexIDs)
  {
    ...
    if (PS3TMAPI.FAILED(res))
      return res;
    lwMutexIDs = new uint[(IntPtr) numLWMutexes];
  ...
  private static extern PS3TMAPI.SNRESULT GetLightWeightMutexInfoX86(
    int target,
    uint processId,
    uint lwMutexId,
    ref uint bufferSize,
  ...
  private static extern PS3TMAPI.SNRESULT GetLightWeightMutexInfoX64(
    int target,
    uint processId,
    uint lwMutexId,
    ref uint bufferSize,
  ...
  public static PS3TMAPI.SNRESULT GetLightWeightMutexInfo(
    int target,
    uint processID,
    uint lwMutexID,
    out PS3TMAPI.LWMutexInfo lwMutexInfo)
  {
    ...
    lwMutexInfo.WaitingThreads = new ulong[(IntPtr) storage.NumWaitingThreads];
  ...
  private static extern PS3TMAPI.SNRESULT GetConditionalVariableListX86(
    int target,
    uint processId,
    ref uint numConditionVars,
    uint[] conditionVarList);

  [DllImport("PS3TMAPIX64.dll", EntryPoint = "SNPS3GetConditionalVariableList", CallingConvention = CallingConvention.Cdecl)]
  private static extern PS3TMAPI.SNRESULT GetConditionalVariableListX64(
    int target,
    uint processId,
    ref uint numConditionVars,
    uint[] conditionVarList);

  public static PS3TMAPI.SNRESULT GetConditionalVariableList(
    int target,
    uint processID,
    out uint[] conditionVarIDs)
  {
    ...
    if (PS3TMAPI.FAILED(res))
      return res;
    conditionVarIDs = new uint[(IntPtr) numConditionVars];
  ...
  private static extern PS3TMAPI.SNRESULT GetConditionalVariableInfoX86(
    int target,
    uint processId,
    uint conditionVarId,
    ref uint bufferSize,
  ...
  private static extern PS3TMAPI.SNRESULT GetConditionalVariableInfoX64(
    int target,
    uint processId,
    uint conditionVarId,
    ref uint bufferSize,
  ...
  public static PS3TMAPI.SNRESULT GetConditionalVariableInfo(
    int target,
    uint processID,
    uint conditionVarID,
    out PS3TMAPI.ConditionVarInfo conditionVarInfo)
  {
    ...
    conditionVarInfo.WaitingThreads = new ulong[(IntPtr) storage.NumWaitingThreads];
    for (int index = 0; (long) index < (long) storage.NumWaitingThreads; ++index)
  ...
  private static extern PS3TMAPI.SNRESULT GetLightWeightConditionalListX86(
    int target,
    uint processId,
    ref uint numLWConditionVars,
    uint[] lwConditionVarList);

  [DllImport("PS3TMAPIX64.dll", EntryPoint = "SNPS3GetLightWeightConditionalList", CallingConvention = CallingConvention.Cdecl)]
  private static extern PS3TMAPI.SNRESULT GetLightWeightConditionalListX64(
    int target,
    uint processId,
    ref uint numLWConditionVars,
    uint[] lwConditionVarList);

  public static PS3TMAPI.SNRESULT GetLightWeightConditionalList(
    int target,
    uint processID,
    out uint[] lwConditionVarIDs)
  {
    ...
    if (PS3TMAPI.FAILED(res))
      return res;
    lwConditionVarIDs = new uint[(IntPtr) numLWConditionVars];
  ...
  private static extern PS3TMAPI.SNRESULT GetLightWeightConditionalInfoX86(
    int target,
    uint processId,
    uint lwCondVarId,
    ref uint bufferSize,
  ...
  private static extern PS3TMAPI.SNRESULT GetLightWeightConditionalInfoX64(
    int target,
    uint processId,
    uint lwCondVarId,
    ref uint bufferSize,
  ...
  public static PS3TMAPI.SNRESULT GetLightWeightConditionalInfo(
    int target,
    uint processID,
    uint lwCondVarID,
    out PS3TMAPI.LWConditionVarInfo lwConditonVarInfo)
  {
    ...
    lwConditonVarInfo.WaitingThreads = new ulong[(IntPtr) storage.NumWaitingThreads];
    for (int index = 0; (long) index < (long) storage.NumWaitingThreads; ++index)
  ...
  private static extern PS3TMAPI.SNRESULT GetReadWriteLockListX86(
    int target,
    uint processId,
    ref uint numRWLocks,
    uint[] rwLockList);
  ...
  private static extern PS3TMAPI.SNRESULT GetReadWriteLockListX64(
    int target,
    uint processId,
    ref uint numRWLocks,
    uint[] rwLockList);

  public static PS3TMAPI.SNRESULT GetReadWriteLockList(
    int target,
    uint processID,
    out uint[] rwLockList)
  {
    ...
    if (PS3TMAPI.FAILED(res))
      return res;
    rwLockList = new uint[(IntPtr) numRWLocks];
  ...
  private static extern PS3TMAPI.SNRESULT GetReadWriteLockInfoX86(
    int target,
    uint processId,
    uint rwLockId,
    ref uint bufferSize,
  ...
  private static extern PS3TMAPI.SNRESULT GetReadWriteLockInfoX64(
    int target,
    uint processId,
    uint rwLockId,
    ref uint bufferSize,
  ...
  public static PS3TMAPI.SNRESULT GetReadWriteLockInfo(
    int target,
    uint processID,
    uint rwLockID,
    out PS3TMAPI.RWLockInfo rwLockInfo)
  {
    ...
    rwLockInfo.WaitingThreads = new ulong[(IntPtr) num];
    for (int index = 0; (long) index < (long) num; ++index)
  ...
  private static extern PS3TMAPI.SNRESULT GetSemaphoreListX86(
    int target,
    uint processId,
    ref uint numSemaphores,
    uint[] semaphoreList);

  [DllImport("PS3TMAPIX64.dll", EntryPoint = "SNPS3GetSemaphoreList", CallingConvention = CallingConvention.Cdecl)]
  private static extern PS3TMAPI.SNRESULT GetSemaphoreListX64(
    int target,
    uint processId,
    ref uint numSemaphores,
    uint[] semaphoreList);

  public static PS3TMAPI.SNRESULT GetSemaphoreList(
    int target,
    uint processID,
    out uint[] semaphoreIDs)
  {
    ...
    if (PS3TMAPI.FAILED(res))
      return res;
    semaphoreIDs = new uint[(IntPtr) numSemaphores];
  ...
  private static extern PS3TMAPI.SNRESULT GetSemaphoreInfoX86(
    int target,
    uint processId,
    uint semaphoreId,
    ref uint bufferSize,
  ...
  private static extern PS3TMAPI.SNRESULT GetSemaphoreInfoX64(
    int target,
    uint processId,
    uint semaphoreId,
    ref uint bufferSize,
  ...
  public static PS3TMAPI.SNRESULT GetSemaphoreInfo(
    int target,
    uint processID,
    uint semaphoreID,
    out PS3TMAPI.SemaphoreInfo semaphoreInfo)
  {
    ...
    semaphoreInfo.WaitingThreads = new ulong[(IntPtr) storage.NumWaitingThreads];
    for (int index = 0; (long) index < (long) storage.NumWaitingThreads; ++index)
  ...
  private static extern PS3TMAPI.SNRESULT GetEventQueueListX86(
    int target,
    uint processId,
    ref uint numEventQueues,
    uint[] eventQueueList);

  [DllImport("PS3TMAPIX64.dll", EntryPoint = "SNPS3GetEventQueueList", CallingConvention = CallingConvention.Cdecl)]
  private static extern PS3TMAPI.SNRESULT GetEventQueueListX64(
    int target,
    uint processId,
    ref uint numEventQueues,
    uint[] eventQueueList);

  public static PS3TMAPI.SNRESULT GetEventQueueList(
    int target,
    uint processID,
    out uint[] eventQueueIDs)
  {
    ...
    if (PS3TMAPI.FAILED(res))
      return res;
    eventQueueIDs = new uint[(IntPtr) numEventQueues];
  ...
  private static extern PS3TMAPI.SNRESULT GetEventQueueInfoX86(
    int target,
    uint processId,
    uint eventQueueId,
    ref uint bufferSize,
  ...
  private static extern PS3TMAPI.SNRESULT GetEventQueueInfoX64(
    int target,
    uint processId,
    uint eventQueueId,
    ref uint bufferSize,
  ...
  public static PS3TMAPI.SNRESULT GetEventQueueInfo(
    int target,
    uint processID,
    uint eventQueueID,
    out PS3TMAPI.EventQueueInfo eventQueueInfo)
  {
    ...
    eventQueueInfo.WaitingThreadIDs = new ulong[(IntPtr) structure.NumWaitingThreads];
    ...
    eventQueueInfo.QueueEntries = new PS3TMAPI.SystemEvent[(IntPtr) structure.NumReadableEvQueue];
  ...
  private static extern PS3TMAPI.SNRESULT GetEventFlagListX86(
    int target,
    uint processId,
    ref uint numEventFlags,
    uint[] eventFlagList);

  [DllImport("PS3TMAPIX64.dll", EntryPoint = "SNPS3GetEventFlagList", CallingConvention = CallingConvention.Cdecl)]
  private static extern PS3TMAPI.SNRESULT GetEventFlagListX64(
    int target,
    uint processId,
    ref uint numEventFlags,
    uint[] eventFlagList);

  public static PS3TMAPI.SNRESULT GetEventFlagList(
    int target,
    uint processID,
    out uint[] eventFlagIDs)
  {
    ...
    if (PS3TMAPI.FAILED(res))
      return res;
    eventFlagIDs = new uint[(IntPtr) numEventFlags];
  ...
  private static extern PS3TMAPI.SNRESULT GetEventFlagInfoX86(
    int target,
    uint processId,
    uint eventFlagId,
    ref uint bufferSize,
  ...
  private static extern PS3TMAPI.SNRESULT GetEventFlagInfoX64(
    int target,
    uint processId,
    uint eventFlagId,
    ref uint bufferSize,
  ...
  public static PS3TMAPI.SNRESULT GetEventFlagInfo(
    int target,
    uint processID,
    uint eventFlagID,
    out PS3TMAPI.EventFlagInfo eventFlagInfo)
  {
    ...
    eventFlagInfo.WaitingThreads = new PS3TMAPI.EventFlagWaitThread[(IntPtr) storage];
    for (int index = 0; (long) index < (long) storage; ++index)
  ...
  private static extern PS3TMAPI.SNRESULT EnableAutoStatusUpdateX86(
    int target,
    uint enabled,
  ...
  private static extern PS3TMAPI.SNRESULT EnableAutoStatusUpdateX64(
    int target,
    uint enabled,
    out uint previousState);

  public static PS3TMAPI.SNRESULT EnableAutoStatusUpdate(
    int target,
    bool bEnabled,
    out bool bPreviousState)
  {
    ...
    bPreviousState = previousState != 0U;
    return snresult;
  }

  [DllImport("PS3TMAPI.dll", EntryPoint = "SNPS3GetPowerStatus", CallingConvention = CallingConvention.Cdecl)]
  private static extern PS3TMAPI.SNRESULT GetPowerStatusX86(
    int target,
    out PS3TMAPI.PowerStatus status);

  [DllImport("PS3TMAPIX64.dll", EntryPoint = "SNPS3GetPowerStatus", CallingConvention = CallingConvention.Cdecl)]
  private static extern PS3TMAPI.SNRESULT GetPowerStatusX64(
    int target,
    out PS3TMAPI.PowerStatus status);

  public static PS3TMAPI.SNRESULT GetPowerStatus(
    int target,
    out PS3TMAPI.PowerStatus status)
  {
    if (!PS3TMAPI.Is32Bit())
  ...
  private static extern PS3TMAPI.SNRESULT GetUserMemoryStatsX86(
    int target,
    uint processId,
    out PS3TMAPI.UserMemoryStats memoryStats);

  [DllImport("PS3TMAPIX64.dll", EntryPoint = "SNPS3GetUserMemoryStats", CallingConvention = CallingConvention.Cdecl)]
  private static extern PS3TMAPI.SNRESULT GetUserMemoryStatsX64(
    int target,
    uint processId,
    out PS3TMAPI.UserMemoryStats memoryStats);

  public static PS3TMAPI.SNRESULT GetUserMemoryStats(
    int target,
    uint processID,
    out PS3TMAPI.UserMemoryStats memoryStats)
  {
  ...
  private static extern PS3TMAPI.SNRESULT SetDefaultLoadPriorityX86(
    int target,
    uint priority);

  [DllImport("PS3TMAPIX64.dll", EntryPoint = "SNPS3SetDefaultLoadPriority", CallingConvention = CallingConvention.Cdecl)]
  private static extern PS3TMAPI.SNRESULT SetDefaultLoadPriorityX64(
    int target,
    uint priority);
  ...
  private static extern PS3TMAPI.SNRESULT GetDefaultLoadPriorityX86(
    int target,
    out uint priority);

  [DllImport("PS3TMAPIX64.dll", EntryPoint = "SNPS3GetDefaultLoadPriority", CallingConvention = CallingConvention.Cdecl)]
  private static extern PS3TMAPI.SNRESULT GetDefaultLoadPriorityX64(
    int target,
    out uint priority);
  ...
  private static extern PS3TMAPI.SNRESULT GetGamePortIPAddrDataX86(
    int target,
    string deviceName,
    out PS3TMAPI.GamePortIPAddressData ipAddressData);

  [DllImport("PS3TMAPIX64.dll", EntryPoint = "SNPS3GetGamePortIPAddrData", CallingConvention = CallingConvention.Cdecl)]
  private static extern PS3TMAPI.SNRESULT GetGamePortIPAddrDataX64(
    int target,
    string deviceName,
    out PS3TMAPI.GamePortIPAddressData ipAddressData);

  public static PS3TMAPI.SNRESULT GetGamePortIPAddrData(
    int target,
    string deviceName,
    out PS3TMAPI.GamePortIPAddressData ipAddressData)
  {
  ...
  private static extern PS3TMAPI.SNRESULT GetGamePortDebugIPAddrDataX86(
    int target,
    string deviceName,
    out PS3TMAPI.GamePortIPAddressData data);

  [DllImport("PS3TMAPIX64.dll", EntryPoint = "SNPS3GetGamePortDebugIPAddrData", CallingConvention = CallingConvention.Cdecl)]
  private static extern PS3TMAPI.SNRESULT GetGamePortDebugIPAddrDataX64(
    int target,
    string deviceName,
    out PS3TMAPI.GamePortIPAddressData data);

  public static PS3TMAPI.SNRESULT GetGamePortDebugIPAddrData(
    int target,
    string deviceName,
    out PS3TMAPI.GamePortIPAddressData ipAddressData)
  {
  ...
  private static extern PS3TMAPI.SNRESULT SetDABRX86(
    int target,
    uint processId,
    ulong address);

  [DllImport("PS3TMAPIX64.dll", EntryPoint = "SNPS3SetDABR", CallingConvention = CallingConvention.Cdecl)]
  private static extern PS3TMAPI.SNRESULT SetDABRX64(
    int target,
    uint processId,
    ulong address);
  ...
  private static extern PS3TMAPI.SNRESULT GetDABRX86(
    int target,
    uint processId,
    out ulong address);

  [DllImport("PS3TMAPIX64.dll", EntryPoint = "SNPS3GetDABR", CallingConvention = CallingConvention.Cdecl)]
  private static extern PS3TMAPI.SNRESULT GetDABRX64(
    int target,
    uint processId,
    out ulong address);
  ...
  private static extern PS3TMAPI.SNRESULT SetRSXProfilingFlagsX86(
    int target,
    ulong rsxFlags);

  [DllImport("PS3TMAPIX64.dll", EntryPoint = "SNPS3SetRSXProfilingFlags", CallingConvention = CallingConvention.Cdecl)]
  private static extern PS3TMAPI.SNRESULT SetRSXProfilingFlagsX64(
    int target,
    ulong rsxFlags);

  public static PS3TMAPI.SNRESULT SetRSXProfilingFlags(
    int target,
    PS3TMAPI.RSXProfilingFlag rsxFlags)
  {
    if (!PS3TMAPI.Is32Bit())
  ...
  private static extern PS3TMAPI.SNRESULT GetRSXProfilingFlagsX86(
    int target,
    out ulong rsxFlags);

  [DllImport("PS3TMAPIX64.dll", EntryPoint = "SNPS3GetRSXProfilingFlags", CallingConvention = CallingConvention.Cdecl)]
  private static extern PS3TMAPI.SNRESULT GetRSXProfilingFlagsX64(
    int target,
    out ulong rsxFlags);

  public static PS3TMAPI.SNRESULT GetRSXProfilingFlags(
    int target,
    out PS3TMAPI.RSXProfilingFlag rsxFlags)
  {
    ulong rsxFlags1;
  ...
  private static extern PS3TMAPI.SNRESULT SetCustomParamSFOMappingDirectoryX86(
    int target,
    IntPtr paramSfoDir);

  [DllImport("PS3TMAPIX64.dll", EntryPoint = "SNPS3SetCustomParamSFOMappingDirectory", CallingConvention = CallingConvention.Cdecl)]
  private static extern PS3TMAPI.SNRESULT SetCustomParamSFOMappingDirectoryX64(
    int target,
    IntPtr paramSfoDir);

  public static PS3TMAPI.SNRESULT SetCustomParamSFOMappingDirectory(
    int target,
    string paramSFODir)
  {
  ...
  private static extern PS3TMAPI.SNRESULT GetXMBSettingsX86(
    int target,
    IntPtr buffer,
    ref uint bufferSize,
    bool bUpdateCache);
  ...
  private static extern PS3TMAPI.SNRESULT GetXMBSettingsX64(
    int target,
    IntPtr buffer,
    ref uint bufferSize,
    bool bUpdateCache);

  public static PS3TMAPI.SNRESULT GetXMBSettings(
    int target,
    out string xmbSettings,
    bool bUpdateCache)
  {
  ...
  private static extern PS3TMAPI.SNRESULT SetXMBSettingsX86(
    int target,
    string xmbSettings,
    bool bUpdateCache);

  [DllImport("PS3TMAPIX64.dll", EntryPoint = "SNPS3SetXMBSettings", CallingConvention = CallingConvention.Cdecl)]
  private static extern PS3TMAPI.SNRESULT SetXMBSettingsX64(
    int target,
    string xmbSettings,
    bool bUpdateCache);

  public static PS3TMAPI.SNRESULT SetXMBSettings(
    int target,
    string xmbSettings,
    bool bUpdateCache)
  {
  ...
  private static extern PS3TMAPI.SNRESULT TriggerCoreDumpX86(
    int target,
    uint processId,
    ulong userData1,
    ulong userData2,
  ...
  private static extern PS3TMAPI.SNRESULT TriggerCoreDumpX64(
    int target,
    uint processId,
    ulong userData1,
    ulong userData2,
  ...
  public static PS3TMAPI.SNRESULT TriggerCoreDump(
    int target,
    uint processID,
    ulong userData1,
    ulong userData2,
  ...
  public static PS3TMAPI.SNRESULT GetCoreDumpFlags(
    int target,
    out PS3TMAPI.CoreDumpFlag flags)
  {
    ulong flags1;
  ...
  private static extern PS3TMAPI.SNRESULT FlashTargetX86(
    int target,
    IntPtr updaterToolPath,
    IntPtr flashImagePath);

  [DllImport("PS3TMAPIX64.dll", EntryPoint = "SNPS3FlashTarget", CallingConvention = CallingConvention.Cdecl)]
  private static extern PS3TMAPI.SNRESULT FlashTargetX64(
    int target,
    IntPtr updaterToolPath,
    IntPtr flashImagePath);

  public static PS3TMAPI.SNRESULT FlashTarget(
    int target,
    string updaterToolPath,
  ...
  private static extern PS3TMAPI.SNRESULT ProcessScatteredSetMemoryX86(
    int target,
    uint processId,
    uint numWrites,
    uint writeSize,
  ...
  public static PS3TMAPI.SNRESULT ProcessScatteredSetMemory(
    int target,
    uint processID,
    PS3TMAPI.ScatteredWrite[] writeData,
    out uint errorCode,
    out uint failedAddress)
  {
    errorCode = 0U;
  ...
  private static extern PS3TMAPI.SNRESULT GetMATRangesX86(
    int target,
    uint processId,
    ref uint rangeCount,
    IntPtr matRanges);
  ...
  private static extern PS3TMAPI.SNRESULT GetMATRangesX64(
    int target,
    uint processId,
    ref uint rangeCount,
    IntPtr matRanges);

  public static PS3TMAPI.SNRESULT GetMATRanges(
    int target,
    uint processID,
    out PS3TMAPI.MATRange[] matRanges)
  {
    ...
    if (PS3TMAPI.FAILED(res2))
      return res2;
    IntPtr unmanagedBuf = scopedGlobalHeapPtr.Get();
    matRanges = new PS3TMAPI.MATRange[(IntPtr) rangeCount];
    for (uint index = 0; index < rangeCount; ++index)
      unmanagedBuf = PS3TMAPI.ReadDataFromUnmanagedIncPtr<uint>(PS3TMAPI.ReadDataFromUnmanagedIncPtr<uint>(unmanagedBuf, ref matRanges[(IntPtr) index].StartAddress), ref matRanges[(IntPtr) index].Size);
    return res2;
  }

  [DllImport("PS3TMAPI.dll", EntryPoint = "SNPS3GetMATConditions", CallingConvention = CallingConvention.Cdecl)]
  private static extern PS3TMAPI.SNRESULT GetMATConditionsX86(
    int target,
    uint processId,
    ref uint rangeCount,
    IntPtr ranges,
  ...
  private static extern PS3TMAPI.SNRESULT GetMATConditionsX64(
    int target,
    uint processId,
    ref uint rangeCount,
    IntPtr ranges,
  ...
  public static PS3TMAPI.SNRESULT GetMATConditions(
    int target,
    uint processID,
    ref PS3TMAPI.MATRange[] matRanges)
  {
    ...
    for (int index1 = 0; (long) index1 < (long) length; ++index1)
    {
      ...
      matRanges[index1].PageConditions = new PS3TMAPI.MATCondition[(IntPtr) num];
  ...
  private static extern PS3TMAPI.SNRESULT SetMATConditionsX86(
    int target,
    uint processId,
    uint rangeCount,
    uint bufSize,
  ...
  private static extern PS3TMAPI.SNRESULT SetMATConditionsX64(
    int target,
    uint processId,
    uint rangeCount,
    uint bufSize,
  ...
  public static PS3TMAPI.SNRESULT SetMATConditions(
    int target,
    uint processID,
    PS3TMAPI.MATRange[] matRanges)
  {
    if (matRanges == null || matRanges.Length < 1)
      return PS3TMAPI.SNRESULT.SN_E_BAD_PARAM;
  ...
  private static extern PS3TMAPI.SNRESULT RegisterPadPlaybackNotificationHandlerX86(
    int target,
    PS3TMAPI.HandleEventCallbackPriv callback,
    IntPtr userData);
  ...
  private static extern PS3TMAPI.SNRESULT RegisterPadPlaybackNotificationHandlerX64(
    int target,
    PS3TMAPI.HandleEventCallbackPriv callback,
    IntPtr userData);

  public static PS3TMAPI.SNRESULT RegisterPadPlaybackHandler(
    int target,
    PS3TMAPI.PadPlaybackCallback callback,
    ref object userData)
  {
    if (callback == null)
      return PS3TMAPI.SNRESULT.SN_E_BAD_PARAM;
  ...
  private static extern PS3TMAPI.SNRESULT SendPadPlaybackDataX86(
    int target,
    ref PS3TMAPI.PadData data);

  [DllImport("PS3TMAPIX64.dll", EntryPoint = "SNPS3SendPadPlaybackData", CallingConvention = CallingConvention.Cdecl)]
  private static extern PS3TMAPI.SNRESULT SendPadPlaybackDataX64(
    int target,
    ref PS3TMAPI.PadData data);
  ...
  private static extern PS3TMAPI.SNRESULT RegisterPadCaptureHandlerX86(
    int target,
    PS3TMAPI.HandleEventCallbackPriv callback,
    IntPtr userData);

  [DllImport("PS3TMAPIX64.dll", EntryPoint = "SNPS3RegisterPadCaptureHandler", CallingConvention = CallingConvention.Cdecl)]
  private static extern PS3TMAPI.SNRESULT RegisterPadCaptureHandlerX64(
    int target,
    PS3TMAPI.HandleEventCallbackPriv callback,
    IntPtr userData);

  public static PS3TMAPI.SNRESULT RegisterPadCaptureHandler(
    int target,
    PS3TMAPI.PadCaptureCallback callback,
    ref object userData)
  {
    if (callback == null)
      return PS3TMAPI.SNRESULT.SN_E_BAD_PARAM;
  ...
  private static void MarshalPadCaptureEvent(
    int target,
    uint param,
    PS3TMAPI.SNRESULT res,
    uint length,
  ...
  private static void MarshalPadPlaybackEvent(
    int target,
    uint param,
    PS3TMAPI.SNRESULT result,
    uint length,
  ...
  private static extern PS3TMAPI.SNRESULT GetVRAMCaptureFlagsX86(
    int target,
    out ulong vramFlags);

  [DllImport("PS3TMAPIX64.dll", EntryPoint = "SNPS3GetVRAMCaptureFlags", CallingConvention = CallingConvention.Cdecl)]
  private static extern PS3TMAPI.SNRESULT GetVRAMCaptureFlagsX64(
    int target,
    out ulong vramFlags);

  public static PS3TMAPI.SNRESULT GetVRAMCaptureFlags(
    int target,
    out PS3TMAPI.VRAMCaptureFlag vramFlags)
  {
    ulong vramFlags1;
  ...
  private static extern PS3TMAPI.SNRESULT SetVRAMCaptureFlagsX86(
    int target,
    ulong vramFlags);

  [DllImport("PS3TMAPIX64.dll", EntryPoint = "SNPS3SetVRAMCaptureFlags", CallingConvention = CallingConvention.Cdecl)]
  private static extern PS3TMAPI.SNRESULT SetVRAMCaptureFlagsX64(
    int target,
    ulong vramFlags);

  public static PS3TMAPI.SNRESULT SetVRAMCaptureFlags(
    int target,
    PS3TMAPI.VRAMCaptureFlag vramFlags)
  {
    if (!PS3TMAPI.Is32Bit())
  ...
  private static extern PS3TMAPI.SNRESULT GetVRAMInformationX86(
    int target,
    uint processId,
    out PS3TMAPI.VramInfoPriv primaryVRAMInfo,
    out PS3TMAPI.VramInfoPriv secondaryVRAMInfo);

  [DllImport("PS3TMAPIX64.dll", EntryPoint = "SNPS3GetVRAMInformation", CallingConvention = CallingConvention.Cdecl)]
  private static extern PS3TMAPI.SNRESULT GetVRAMInformationX64(
    int target,
    uint processId,
    out PS3TMAPI.VramInfoPriv primaryVRAMInfo,
    out PS3TMAPI.VramInfoPriv secondaryVRAMInfo);

  public static PS3TMAPI.SNRESULT GetVRAMInformation(
    int target,
    uint processID,
    out PS3TMAPI.VRAMInfo primaryVRAMInfo,
    out PS3TMAPI.VRAMInfo secondaryVRAMInfo)
  {
  ...
  private static extern PS3TMAPI.SNRESULT VRAMCaptureX86(
    int target,
    uint processId,
    IntPtr vramInfo,
    IntPtr fileName);
  ...
  private static extern PS3TMAPI.SNRESULT VRAMCaptureX64(
    int target,
    uint processId,
    IntPtr vramInfo,
    IntPtr fileName);

  public static PS3TMAPI.SNRESULT VRAMCapture(
    int target,
    uint processID,
    PS3TMAPI.VRAMInfo vramInfo,
    string fileName)
  {
    PS3TMAPI.ScopedGlobalHeapPtr scopedGlobalHeapPtr1 = new PS3TMAPI.ScopedGlobalHeapPtr(IntPtr.Zero);
    if (vramInfo != null)
  ...
  private static void CustomProtocolHandler(
    int target,
    PS3TMAPI.PS3Protocol ps3Protocol,
    IntPtr unmanagedBuf,
    uint length,
    IntPtr userData)
  {
  ...
  private static extern PS3TMAPI.SNRESULT RegisterCustomProtocolExX86(
    int target,
    uint protocol,
    uint port,
    string lparDesc,
    uint priority,
    out PS3TMAPI.PS3Protocol ps3Protocol,
    PS3TMAPI.CustomProtocolCallbackPriv callback,
    IntPtr userData);

  [DllImport("PS3TMAPIX64.dll", EntryPoint = "SNPS3RegisterCustomProtocolEx", CallingConvention = CallingConvention.Cdecl)]
  private static extern PS3TMAPI.SNRESULT RegisterCustomProtocolExX64(
    int target,
    uint protocol,
    uint port,
    string lparDesc,
  ...
  public static PS3TMAPI.SNRESULT RegisterCustomProtocol(
    int target,
    uint protocol,
    uint port,
    string lparDesc,
    uint priority,
    out PS3TMAPI.PS3Protocol ps3Protocol,
    PS3TMAPI.CustomProtocolCallback callback,
    ref object userData)
  {
  ...
  private static extern PS3TMAPI.SNRESULT UnregisterCustomProtocolX86(
    int target,
    ref PS3TMAPI.PS3Protocol protocol);

  [DllImport("PS3TMAPIX64.dll", EntryPoint = "SNPS3UnRegisterCustomProtocol", CallingConvention = CallingConvention.Cdecl)]
  private static extern PS3TMAPI.SNRESULT UnregisterCustomProtocolX64(
    int target,
    ref PS3TMAPI.PS3Protocol protocol);

  public static PS3TMAPI.SNRESULT UnregisterCustomProtocol(
    int target,
    PS3TMAPI.PS3Protocol ps3Protocol)
  {
  ...
  private static extern PS3TMAPI.SNRESULT ForceUnregisterCustomProtocolX86(
    int target,
    ref PS3TMAPI.PS3Protocol protocol);

  [DllImport("PS3TMAPIX64.dll", EntryPoint = "SNPS3ForceUnRegisterCustomProtocol", CallingConvention = CallingConvention.Cdecl)]
  private static extern PS3TMAPI.SNRESULT ForceUnregisterCustomProtocolX64(
    int target,
    ref PS3TMAPI.PS3Protocol protocol);

  public static PS3TMAPI.SNRESULT ForceUnregisterCustomProtocol(
    int target,
    PS3TMAPI.PS3Protocol ps3Protocol)
  {
  ...
  private static extern PS3TMAPI.SNRESULT SendCustomProtocolDataX86(
    int target,
    ref PS3TMAPI.PS3Protocol protocol,
    byte[] data,
    int length);
  ...
  private static extern PS3TMAPI.SNRESULT SendCustomProtocolDataX64(
    int target,
    ref PS3TMAPI.PS3Protocol protocol,
    byte[] data,
    int length);

  public static PS3TMAPI.SNRESULT SendCustomProtocolData(
    int target,
    PS3TMAPI.PS3Protocol ps3Protocol,
    byte[] data)
  {
  ...
  private static extern PS3TMAPI.SNRESULT SetFileServingEventFlagsX86(
    int target,
    ulong eventFlags);

  [DllImport("PS3TMAPIX64.dll", EntryPoint = "SNPS3SetFileServingEventFlags", CallingConvention = CallingConvention.Cdecl)]
  private static extern PS3TMAPI.SNRESULT SetFileServingEventFlagsX64(
    int target,
    ulong eventFlags);

  public static PS3TMAPI.SNRESULT SetFileServingEventFlags(
    int target,
    PS3TMAPI.FileServingEventFlag eventFlags)
  {
    if (!PS3TMAPI.Is32Bit())
  ...
  private static extern PS3TMAPI.SNRESULT GetFileServingEventFlagsX86(
    int target,
    ref ulong eventFlags);

  [DllImport("PS3TMAPIX64.dll", EntryPoint = "SNPS3GetFileServingEventFlags", CallingConvention = CallingConvention.Cdecl)]
  private static extern PS3TMAPI.SNRESULT GetFileServingEventFlagsX64(
    int target,
    ref ulong eventFlags);

  public static PS3TMAPI.SNRESULT GetFileServingEventFlags(
    int target,
    out PS3TMAPI.FileServingEventFlag eventFlags)
  {
    ulong eventFlags1 = 0;
  ...
  private static extern PS3TMAPI.SNRESULT SetCaseSensitiveFileServingX86(
    int target,
    bool bOn,
    out bool bOldSetting);

  [DllImport("PS3TMAPIX64.dll", EntryPoint = "SNPS3SetCaseSensitiveFileServing", CallingConvention = CallingConvention.Cdecl)]
  private static extern PS3TMAPI.SNRESULT SetCaseSensitiveFileServingX64(
    int target,
    bool bOn,
    out bool bOldSetting);

  public static PS3TMAPI.SNRESULT SetCaseSensitiveFileServing(
    int target,
    bool bOn,
    out bool bOldSetting)
  {
  ...
  private static extern PS3TMAPI.SNRESULT RegisterFTPEventHandlerX86(
    int target,
    PS3TMAPI.HandleEventCallbackPriv callback,
    IntPtr userData);

  [DllImport("PS3TMAPIX64.dll", EntryPoint = "SNPS3RegisterFTPEventHandler", CallingConvention = CallingConvention.Cdecl)]
  private static extern PS3TMAPI.SNRESULT RegisterFTPEventHandlerX64(
    int target,
    PS3TMAPI.HandleEventCallbackPriv callback,
    IntPtr userData);

  public static PS3TMAPI.SNRESULT RegisterFTPEventHandler(
    int target,
    PS3TMAPI.FTPEventCallback callback,
    ref object userData)
  {
    if (callback == null)
      return PS3TMAPI.SNRESULT.SN_E_BAD_PARAM;
  ...
  private static void MarshalFTPEvent(
    int target,
    uint param,
    PS3TMAPI.SNRESULT result,
    uint length,
    IntPtr data)
  {
    ...
    if (length > 0U)
    {
      ...
      ftpNotifications = new PS3TMAPI.FTPNotification[(IntPtr) num];
      for (int index = 0; (long) index < (long) num; ++index)
  ...
  private static extern PS3TMAPI.SNRESULT RegisterFileTraceHandlerX86(
    int target,
    PS3TMAPI.HandleEventCallbackPriv callback,
    IntPtr userData);

  [DllImport("PS3TMAPIX64.dll", EntryPoint = "SNPS3RegisterFileTraceHandler", CallingConvention = CallingConvention.Cdecl)]
  private static extern PS3TMAPI.SNRESULT RegisterFileTraceHandlerX64(
    int target,
    PS3TMAPI.HandleEventCallbackPriv callback,
    IntPtr userData);

  public static PS3TMAPI.SNRESULT RegisterFileTraceHandler(
    int target,
    PS3TMAPI.FileTraceCallback callback,
    ref object userData)
  {
    if (callback == null)
      return PS3TMAPI.SNRESULT.SN_E_BAD_PARAM;
  ...
  private static void MarshalFileTraceEvent(
    int target,
    uint param,
    PS3TMAPI.SNRESULT result,
    uint length,
    IntPtr data)
  {
    ...
    if (length < num2)
      return;
    fileTraceEvent.BackTraceData = new byte[(IntPtr) storage3];
    ...
    switch (fileTraceEvent.TraceType)
    {
      ...
      case PS3TMAPI.FileTraceType.WidgetOpen:
        ...
        fileTraceEvent.LogData.LogType8.VArg = new byte[(IntPtr) storage10];
  ...
  private static extern PS3TMAPI.SNRESULT StartFileTraceX86(
    int target,
    uint processId,
    uint size,
    IntPtr filename);
  ...
  private static extern PS3TMAPI.SNRESULT StartFileTraceX64(
    int target,
    uint processId,
    uint size,
    IntPtr filename);

  public static PS3TMAPI.SNRESULT StartFileTrace(
    int target,
    uint processID,
    uint size,
    string filename)
  ...
  private static extern PS3TMAPI.SNRESULT UploadFileX86(
    int target,
    IntPtr source,
    IntPtr dest,
  ...
  private static extern PS3TMAPI.SNRESULT UploadFileX64(
    int target,
    IntPtr source,
    IntPtr dest,
    out uint transactionId);

  public static PS3TMAPI.SNRESULT UploadFile(
    int target,
    string source,
    string dest,
    out uint txID)
  ...
  private static IntPtr FileTransferInfoMarshalHelper(
    IntPtr dataPtr,
    ref PS3TMAPI.FileTransferInfo fileTransferInfo)
  {
  ...
  private static extern PS3TMAPI.SNRESULT GetFileTransferListX86(
    int target,
    ref uint count,
    IntPtr fileTransferInfo);

  [DllImport("PS3TMAPIX64.dll", EntryPoint = "SNPS3GetFileTransferList", CallingConvention = CallingConvention.Cdecl)]
  private static extern PS3TMAPI.SNRESULT GetFileTransferListX64(
    int target,
    ref uint count,
    IntPtr fileTransferInfo);

  public static PS3TMAPI.SNRESULT GetFileTransferList(
    int target,
    out PS3TMAPI.FileTransferInfo[] fileTransfers)
  {
    ...
    fileTransfers = new PS3TMAPI.FileTransferInfo[(IntPtr) count];
    for (uint index = 0; index < count; ++index)
      dataPtr = PS3TMAPI.FileTransferInfoMarshalHelper(dataPtr, ref fileTransfers[(IntPtr) index]);
    return res2;
  }

  [DllImport("PS3TMAPI.dll", EntryPoint = "SNPS3GetFileTransferInfo", CallingConvention = CallingConvention.Cdecl)]
  private static extern PS3TMAPI.SNRESULT GetFileTransferInfoX86(
    int target,
    uint txId,
    IntPtr fileTransferInfoPtr);

  [DllImport("PS3TMAPIX64.dll", EntryPoint = "SNPS3GetFileTransferInfo", CallingConvention = CallingConvention.Cdecl)]
  private static extern PS3TMAPI.SNRESULT GetFileTransferInfoX64(
    int target,
    uint txId,
    IntPtr fileTransferInfoPtr);

  public static PS3TMAPI.SNRESULT GetFileTransferInfo(
    int target,
    uint txID,
    out PS3TMAPI.FileTransferInfo fileTransferInfo)
  {
  ...
  private static extern PS3TMAPI.SNRESULT RetryFileTransferX86(
    int target,
    uint txID,
    bool bForce);

  [DllImport("PS3TMAPIX64.dll", EntryPoint = "SNPS3RetryFileTransfer", CallingConvention = CallingConvention.Cdecl)]
  private static extern PS3TMAPI.SNRESULT RetryFileTransferX64(
    int target,
    uint txID,
    bool bForce);
  ...
  private static extern PS3TMAPI.SNRESULT RemoveTransferItemsByStatusX86(
    int target,
    uint filter);

  [DllImport("PS3TMAPIX64.dll", EntryPoint = "SNPS3RemoveTransferItemsByStatus", CallingConvention = CallingConvention.Cdecl)]
  private static extern PS3TMAPI.SNRESULT SNPS3RemoveTransferItemsByStatusX64(
    int target,
    uint filter);
  ...
  private static extern PS3TMAPI.SNRESULT GetDirectoryListX86(
    int target,
    IntPtr directory,
    ref uint numDirEntries,
    IntPtr dirEntryList);

  [DllImport("PS3TMAPIX64.dll", EntryPoint = "SNPS3GetDirectoryList", CallingConvention = CallingConvention.Cdecl)]
  private static extern PS3TMAPI.SNRESULT GetDirectoryListX64(
    int target,
    IntPtr directory,
    ref uint numDirEntries,
    IntPtr dirEntryList);

  public static PS3TMAPI.SNRESULT GetDirectoryList(
    int target,
    string directory,
    out PS3TMAPI.DirEntry[] dirEntries)
  {
    ...
    if (PS3TMAPI.SUCCEEDED(res2))
    {
      ...
      dirEntries = new PS3TMAPI.DirEntry[(IntPtr) numDirEntries];
  ...
  private static IntPtr DirEntryExMarshalHelper(
    IntPtr dataPtr,
    ref PS3TMAPI.DirEntryEx dirEntryEx)
  {
  ...
  private static extern PS3TMAPI.SNRESULT GetDirectoryListExX86(
    int target,
    IntPtr dirPtr,
    ref uint numDirEntries,
    IntPtr dirEntryListEx,
    ref PS3TMAPI.TargetTimezone timeZone);

  [DllImport("PS3TMAPIX64.dll", EntryPoint = "SNPS3GetDirectoryListEx", CallingConvention = CallingConvention.Cdecl)]
  private static extern PS3TMAPI.SNRESULT GetDirectoryListExX64(
    int target,
    IntPtr dirPtr,
    ref uint numDirEntries,
    IntPtr dirEntryListEx,
  ...
  public static PS3TMAPI.SNRESULT GetDirectoryListEx(
    int target,
    string directory,
    out PS3TMAPI.DirEntryEx[] dirEntries,
    out PS3TMAPI.TargetTimezone timeZone)
  {
    ...
    {
      IntPtr dataPtr = scopedGlobalHeapPtr2.Get();
      dirEntries = new PS3TMAPI.DirEntryEx[(IntPtr) numDirEntries];
      for (int index = 0; (long) index < (long) numDirEntries; ++index)
  ...
  private static extern PS3TMAPI.SNRESULT MakeDirectoryX86(
    int target,
    IntPtr directory,
    uint mode);

  [DllImport("PS3TMAPIX64.dll", EntryPoint = "SNPS3MakeDirectory", CallingConvention = CallingConvention.Cdecl)]
  private static extern PS3TMAPI.SNRESULT MakeDirectoryX64(
    int target,
    IntPtr directory,
    uint mode);
  ...
  private static extern PS3TMAPI.SNRESULT DeleteFileExX86(
    int target,
    IntPtr path,
    uint msTimeout);

  [DllImport("PS3TMAPIX64.dll", EntryPoint = "SNPS3DeleteEx", CallingConvention = CallingConvention.Cdecl)]
  private static extern PS3TMAPI.SNRESULT DeleteFileExX64(
    int target,
    IntPtr path,
    uint msTimeout);
  ...
  private static extern PS3TMAPI.SNRESULT RenameFileX86(
    int target,
    IntPtr source,
    IntPtr dest);

  [DllImport("PS3TMAPIX64.dll", EntryPoint = "SNPS3Rename", CallingConvention = CallingConvention.Cdecl)]
  private static extern PS3TMAPI.SNRESULT RenameFileX64(
    int target,
    IntPtr source,
    IntPtr dest);
  ...
  private static extern PS3TMAPI.SNRESULT DownloadFileX86(
    int target,
    IntPtr source,
    IntPtr dest,
    out uint transactionId);
  ...
  private static extern PS3TMAPI.SNRESULT DownloadFileX64(
    int target,
    IntPtr source,
    IntPtr dest,
    out uint transactionId);

  public static PS3TMAPI.SNRESULT DownloadFile(
    int target,
    string source,
    string dest,
    out uint txID)
  ...
  private static extern PS3TMAPI.SNRESULT DownloadDirectoryX86(
    int target,
    IntPtr source,
    IntPtr dest,
    out uint lastTransactionId);

  [DllImport("PS3TMAPIX64.dll", EntryPoint = "SNPS3DownloadDirectory", CallingConvention = CallingConvention.Cdecl)]
  private static extern PS3TMAPI.SNRESULT DownloadDirectoryX64(
    int target,
    IntPtr source,
    IntPtr dest,
    out uint lastTransactionId);

  public static PS3TMAPI.SNRESULT DownloadDirectory(
    int target,
    string source,
    string dest,
    out uint lastTxID)
  ...
  private static extern PS3TMAPI.SNRESULT UploadDirectoryX86(
    int target,
    IntPtr source,
    IntPtr dest,
    out uint lastTransactionId);
  ...
  private static extern PS3TMAPI.SNRESULT UploadDirectoryX64(
    int target,
    IntPtr source,
    IntPtr dest,
    out uint lastTransactionId);

  public static PS3TMAPI.SNRESULT UploadDirectory(
    int target,
    string source,
    string dest,
    out uint lastTxID)
  ...
  private static extern PS3TMAPI.SNRESULT StatTargetFileX86(
    int target,
    IntPtr file,
    IntPtr dirEntry);

  [DllImport("PS3TMAPIX64.dll", EntryPoint = "SNPS3StatTargetFile", CallingConvention = CallingConvention.Cdecl)]
  private static extern PS3TMAPI.SNRESULT StatTargetFileX64(
    int target,
    IntPtr file,
    IntPtr dirEntry);

  public static PS3TMAPI.SNRESULT StatTargetFile(
    int target,
    string file,
    out PS3TMAPI.DirEntry dirEntry)
  {
  ...
  private static extern PS3TMAPI.SNRESULT StatTargetFileExX86(
    int target,
    IntPtr file,
    IntPtr dirEntry,
    out PS3TMAPI.TargetTimezone timeZone);
  ...
  private static extern PS3TMAPI.SNRESULT StatTargetFileExX64(
    int target,
    IntPtr file,
    IntPtr dirEntry,
    out PS3TMAPI.TargetTimezone timeZone);

  public static PS3TMAPI.SNRESULT StatTargetFileEx(
    int target,
    string file,
    out PS3TMAPI.DirEntryEx dirEntryEx,
    out PS3TMAPI.TargetTimezone timeZone)
  {
  ...
  public static PS3TMAPI.SNRESULT ChMod(
    int target,
    string filePath,
    PS3TMAPI.ChModFilePermission mode)
  {
  ...
  private static extern PS3TMAPI.SNRESULT SetFileTimeX86(
    int target,
    IntPtr filePath,
    ulong accessTime,
    ulong modifiedTime);
  ...
  private static extern PS3TMAPI.SNRESULT SetFileTimeX64(
    int target,
    IntPtr filePath,
    ulong accessTime,
    ulong modifiedTime);

  public static PS3TMAPI.SNRESULT SetFileTime(
    int target,
    string filePath,
    ulong accessTime,
    ulong modifiedTime)
  ...
  private static extern PS3TMAPI.SNRESULT InstallGameExX86(
    int target,
    IntPtr paramSfoPath,
    out IntPtr titleId,
    out IntPtr targetPath,
    out uint txId);

  [DllImport("PS3TMAPIX64.dll", EntryPoint = "SNPS3InstallGameEx", CallingConvention = CallingConvention.Cdecl)]
  private static extern PS3TMAPI.SNRESULT InstallGameExX64(
    int target,
    IntPtr paramSfoPath,
    out IntPtr titleId,
    out IntPtr targetPath,
  ...
  public static PS3TMAPI.SNRESULT InstallGameEx(
    int target,
    string paramSFOPath,
    out string titleID,
  ...
  private static extern PS3TMAPI.SNRESULT WaitForFileTransferX86(
    int target,
    uint txId,
    out PS3TMAPI.FileTransferNotificationType notificationType,
    uint msTimeout);

  [DllImport("PS3TMAPIX64.dll", EntryPoint = "SNPS3WaitForFileTransfer", CallingConvention = CallingConvention.Cdecl)]
  private static extern PS3TMAPI.SNRESULT WaitForFileTransferX64(
    int target,
    uint txId,
    out PS3TMAPI.FileTransferNotificationType notificationType,
    uint msTimeout);

  public static PS3TMAPI.SNRESULT WaitForFileTransfer(
    int target,
    uint txID,
    out PS3TMAPI.FileTransferNotificationType notificationType,
    uint msTimeout)
  ...
  private static extern PS3TMAPI.SNRESULT FSGetFreeSizeX86(
    int target,
    IntPtr fsDir,
    out uint blockSize,
    out ulong freeBlockCount);

  [DllImport("PS3TMAPIX64.dll", EntryPoint = "SNPS3FSGetFreeSize", CallingConvention = CallingConvention.Cdecl)]
  private static extern PS3TMAPI.SNRESULT FSGetFreeSizeX64(
    int target,
    IntPtr fsDir,
    out uint blockSize,
    out ulong freeBlockCount);

  public static PS3TMAPI.SNRESULT FSGetFreeSize(
    int target,
    string fsDir,
    out uint blockSize,
    out ulong freeBlockCount)
  ...
  private static extern PS3TMAPI.SNRESULT ProcessOfflineFileTraceX86(
    int target,
    IntPtr path);

  [DllImport("PS3TMAPIX64.dll", EntryPoint = "SNPS3ProcessOfflineFileTrace", CallingConvention = CallingConvention.Cdecl)]
  private static extern PS3TMAPI.SNRESULT ProcessOfflineFileTraceX64(
    int target,
    IntPtr path);
  ...
  private static extern PS3TMAPI.SNRESULT BDTransferImageX86(
    int target,
  ...
  private static extern PS3TMAPI.SNRESULT BDTransferImageX64(
    int target,
    IntPtr sourceFileName,
    string destinationDevice,
    out uint transactionId);

  public static PS3TMAPI.SNRESULT BDTransferImage(
    int target,
  ...
  private static extern PS3TMAPI.SNRESULT BDFormatX86(
    int target,
    string deviceName,
    uint formatMode);

  [DllImport("PS3TMAPIX64.dll", EntryPoint = "SNPS3BDFormat", CallingConvention = CallingConvention.Cdecl)]
  private static extern PS3TMAPI.SNRESULT BDFormatX64(
    int target,
    string deviceName,
    uint formatMode);
  ...
  private static extern PS3TMAPI.SNRESULT BDQueryX86(
    int target,
    string deviceName,
    ref PS3TMAPI.BDInfoPriv infoPriv);

  [DllImport("PS3TMAPIX64.dll", EntryPoint = "SNPS3BDQuery", CallingConvention = CallingConvention.Cdecl)]
  private static extern PS3TMAPI.SNRESULT BDQueryX64(
    int target,
    string deviceName,
    ref PS3TMAPI.BDInfoPriv infoPriv);

  public static PS3TMAPI.SNRESULT BDQuery(
    int target,
    string deviceName,
    ref PS3TMAPI.BDInfo info)
  {
  ...
  private static extern PS3TMAPI.SNRESULT RegisterTargetEventHandlerX86(
    int target,
    PS3TMAPI.HandleEventCallbackPriv callback,
    IntPtr userData);

  [DllImport("PS3TMAPIX64.dll", EntryPoint = "SNPS3RegisterTargetEventHandler", CallingConvention = CallingConvention.Cdecl)]
  private static extern PS3TMAPI.SNRESULT RegisterTargetEventHandlerX64(
    int target,
    PS3TMAPI.HandleEventCallbackPriv callback,
    IntPtr userData);

  public static PS3TMAPI.SNRESULT RegisterTargetEventHandler(
    int target,
    PS3TMAPI.TargetEventCallback callback,
    ref object userData)
  {
    if (callback == null)
      return PS3TMAPI.SNRESULT.SN_E_BAD_PARAM;
  ...
  private static void MarshalTargetEvent(
    int target,
    uint param,
    PS3TMAPI.SNRESULT result,
    uint length,
  ...
  private static PS3TMAPI.TargetSpecificEvent MarshalTargetSpecificEvent(
    uint eventSize,
    IntPtr data)
  {
  ...
  private static void EventHandlerWrapper(
    int target,
    PS3TMAPI.EventType type,
    uint param,
    PS3TMAPI.SNRESULT result,
    uint length,
    IntPtr data,
  ...
  private static extern PS3TMAPI.SNRESULT SearchForTargetsX86(
    string ipAddressFrom,
    string ipAddressTo,
    PS3TMAPI.SearchTargetsCallbackPriv callback,
    IntPtr userData,
    int port);

  [DllImport("PS3TMAPIX64.dll", EntryPoint = "SNPS3SearchForTargets", CallingConvention = CallingConvention.Cdecl)]
  private static extern PS3TMAPI.SNRESULT SearchForTargetsX64(
    string ipAddressFrom,
    string ipAddressTo,
    PS3TMAPI.SearchTargetsCallbackPriv callback,
    IntPtr userData,
  ...
  public static PS3TMAPI.SNRESULT SearchForTargets(
    string ipAddressFrom,
    string ipAddressTo,
    PS3TMAPI.SearchTargetsCallback callback,
    object userData,
    int port)
  {
  ...
  private static extern PS3TMAPI.SNRESULT IsValidResolutionX86(
    uint monitorType,
    uint startupResolution);

  [DllImport("PS3TMAPIX64.dll", EntryPoint = "SNPS3IsValidResolution", CallingConvention = CallingConvention.Cdecl)]
  private static extern PS3TMAPI.SNRESULT IsValidResolutionX64(
    uint monitorType,
    uint startupResolution);

  public static PS3TMAPI.SNRESULT IsValidResolution(
    uint monitorType,
    uint startupResolution)
  {
    if (!PS3TMAPI.Is32Bit())
  ...
  private static extern PS3TMAPI.SNRESULT SetDisplaySettingsX86(
    int target,
    IntPtr executable,
    uint monitorType,
    uint connectorType,
  ...
  private static extern PS3TMAPI.SNRESULT SetDisplaySettingsX64(
    int target,
    IntPtr executable,
    uint monitorType,
    uint connectorType,
  ...
  public static PS3TMAPI.SNRESULT SetDisplaySettings(
    int target,
    string executable,
    uint monitorType,
    uint connectorType,
  ...
  private static extern PS3TMAPI.SNRESULT ImportTargetSettingsX86(
    int target,
    IntPtr szFileName);

  [DllImport("PS3TMAPIX64.dll", EntryPoint = "SNPS3ImportTargetSettings", CallingConvention = CallingConvention.Cdecl)]
  private static extern PS3TMAPI.SNRESULT ImportTargetSettingsX64(
    int target,
    IntPtr szFileName);
  ...
  private static extern PS3TMAPI.SNRESULT ExportTargetSettingsX86(
    int target,
    IntPtr szFileName);

  [DllImport("PS3TMAPIX64.dll", EntryPoint = "SNPS3ExportTargetSettings", CallingConvention = CallingConvention.Cdecl)]
  private static extern PS3TMAPI.SNRESULT ExportTargetSettingsX64(
    int target,
    IntPtr szFileName);
  ...
  private static IntPtr ReadAnsiStringFromUnmanagedIncPtr(
    IntPtr unmanagedBuf,
  ...
  private static unsafe string Utf8ToString(IntPtr utf8Ptr, uint maxLength)
  {
    if (utf8Ptr == IntPtr.Zero)
      return "";
    byte* numPtr = (byte*) (void*) utf8Ptr;
    int length;
    for (length = 0; *numPtr != (byte) 0 && (long) length < (long) maxLength; ++length)
      ++numPtr;
  ...
  public enum SNRESULT
  {
    ...
    SN_E_COMMS_EVENT_MISMATCHED_ERR = -39, // 0xFFFFFFD9
    SN_E_CONNECTED = -38, // 0xFFFFFFDA
    SN_E_PROTOCOL_ALREADY_REGISTERED = -37, // 0xFFFFFFDB
    SN_E_COMMAND_CANCELLED = -36, // 0xFFFFFFDC
    SN_E_CONNECT_TO_GAMEPORT_FAILED = -35, // 0xFFFFFFDD
    SN_E_MODULE_NOT_FOUND = -34, // 0xFFFFFFDE
    SN_E_CHECK_TARGET_CONFIGURATION = -33, // 0xFFFFFFDF
    SN_E_LICENSE_ERROR = -32, // 0xFFFFFFE0
    SN_E_LOAD_MODULE_FAILED = -31, // 0xFFFFFFE1
    SN_E_NOT_SUPPORTED_IN_SDK_VERSION = -30, // 0xFFFFFFE2
    SN_E_FILE_ERROR = -29, // 0xFFFFFFE3
    SN_E_BAD_ALIGN = -28, // 0xFFFFFFE4
    SN_E_DEPRECATED = -27, // 0xFFFFFFE5
    SN_E_DATA_TOO_LONG = -26, // 0xFFFFFFE6
    SN_E_INSUFFICIENT_DATA = -25, // 0xFFFFFFE7
    SN_E_EXISTING_CALLBACK = -24, // 0xFFFFFFE8
    SN_E_DECI_ERROR = -23, // 0xFFFFFFE9
    SN_E_BUSY = -22, // 0xFFFFFFEA
    SN_E_BAD_PARAM = -21, // 0xFFFFFFEB
    SN_E_NO_SEL = -20, // 0xFFFFFFEC
    SN_E_NO_TARGETS = -19, // 0xFFFFFFED
    SN_E_BAD_MEMSPACE = -18, // 0xFFFFFFEE
    SN_E_TARGET_RUNNING = -17, // 0xFFFFFFEF
    SN_E_DLL_NOT_INITIALISED = -15, // 0xFFFFFFF1
    SN_E_TM_VERSION = -14, // 0xFFFFFFF2
    SN_E_NOT_LISTED = -13, // 0xFFFFFFF3
    SN_E_OUT_OF_MEM = -12, // 0xFFFFFFF4
    SN_E_BAD_UNIT = -11, // 0xFFFFFFF5
    SN_E_LOAD_ELF_FAILED = -10, // 0xFFFFFFF6
    SN_E_TARGET_IN_USE = -9, // 0xFFFFFFF7
    SN_E_HOST_NOT_FOUND = -8, // 0xFFFFFFF8
    SN_E_TIMEOUT = -7, // 0xFFFFFFF9
    SN_E_TM_COMMS_ERR = -6, // 0xFFFFFFFA
    SN_E_COMMS_ERR = -5, // 0xFFFFFFFB
    SN_E_NOT_CONNECTED = -4, // 0xFFFFFFFC
    SN_E_BAD_TARGET = -3, // 0xFFFFFFFD
    SN_E_TM_NOT_RUNNING = -2, // 0xFFFFFFFE
    SN_E_NOT_IMPL = -1, // 0xFFFFFFFF
    SN_S_OK = 0,
    SN_S_PENDING = 1,
    SN_S_NO_MSG = 3,
    SN_S_TM_VERSION = 4,
  ...
  {
    Default = 0,
    SystemMode = 17, // 0x0000000000000011
    ReleaseMode = 1,
  ...
  {
    BootMode = 17, // 0x0000000000000011
    Memsize = 2,
    BlurayEmulation = 4,
    HDDSpeed = 8,
    BlurayEmuSelect = 32, // 0x0000000000000020
    HostFS = 64, // 0x0000000000000040
    NIC = 128, // 0x0000000000000080
    All = NIC | HostFS | BlurayEmuSelect | HDDSpeed | BlurayEmulation | Memsize | BootMode, // 0x00000000000000FF
  }
  ...
  {
    All = 9223372036854775811, // 0x8000000000000003
  }

  [Flags]
  public enum SystemParameter : ulong
  {
    TargetModel60GB = 281474976710656, // 0x0001000000000000
    TargetModel20GB = 562949953421312, // 0x0002000000000000
    ReleaseCheckMode = 140737488355328, // 0x0000800000000000
  }

  [Flags]
  public enum SystemParameterMask : ulong
  {
    TargetModel = 71776119061217280, // 0x00FF000000000000
    ReleaseCheck = 140737488355328, // 0x0000800000000000
    All = ReleaseCheck | TargetModel, // 0x00FF800000000000
  }
  ...
  public delegate void ServerEventCallback(
    int target,
    PS3TMAPI.SNRESULT res,
    PS3TMAPI.ServerEventType eventType,
    object userData);
  ...
  public enum SystemInfoFlag : uint
  {
    ...
    RTSDKVersion = 4,
    TotalSystemMem = 8,
    AvailableSysMem = 16, // 0x00000010
    DCMBufferSize = 32, // 0x00000020
  }
  ...
  public enum ExtraLoadFlag : ulong
  {
    ...
    EnableCoreDump = 16, // 0x0000000000000010
    EnableAccForRemotePlay = 32, // 0x0000000000000020
    EnableHUDRSXTools = 64, // 0x0000000000000040
    EnableMAT = 128, // 0x0000000000000080
    EnableMiscSettings = 9223372036854775808, // 0x8000000000000000
    GameAttributeInviteMessage = 256, // 0x0000000000000100
    GameAttributeCustomMessage = 512, // 0x0000000000000200
    LoadingPatch = 4096, // 0x0000000000001000
  }

  [Flags]
  public enum ExtraLoadFlagMask : ulong
  {
    GameAttributeMessageMask = 3840, // 0x0000000000000F00
    All = 9223372036854783999, // 0x8000000000001FFF
    OverrideTVGUIMask = 9223372036854775808, // 0x8000000000000000
  }
  ...
  public delegate void TTYCallback(
    int target,
    uint streamID,
    PS3TMAPI.SNRESULT res,
    string data,
  ...
  public delegate void TTYCallbackRaw(
    int target,
    uint streamID,
    PS3TMAPI.SNRESULT res,
    byte[] data,
  ...
  {
    EnableDebugging = 1,
    UseELFPriority = 256, // 0x00000100
    UseELFStackSize = 512, // 0x00000200
    WaitBDMounted = 8192, // 0x00002000
    PPUNotDebug = 65536, // 0x00010000
    SPUNotDebug = 131072, // 0x00020000
    IgnoreDefaults = 2147483648, // 0x80000000
    ParamSFOUseELFDir = 1048576, // 0x00100000
    ParamSFOUseCustomDir = 2097152, // 0x00200000
  }
  ...
  {
    Stack32k = 32, // 0x00000020
    Stack64k = 64, // 0x00000040
    Stack96k = Stack64k | Stack32k, // 0x00000060
    Stack128k = 128, // 0x00000080
    Stack256k = 256, // 0x00000100
    Stack512k = 512, // 0x00000200
    Stack1024k = 1024, // 0x00000400
    StackDefault = Stack64k, // 0x00000040
  }
  ...
  public enum CoreDumpFlag : ulong
  {
    ...
    ToDevUSB = 4,
    ToDevHDD0 = 8,
    DisablePPUExceptionDetection = 36028797018963968, // 0x0080000000000000
    DisableSPUExceptionDetection = 18014398509481984, // 0x0040000000000000
    DisableRSXExceptionDetection = 9007199254740992, // 0x0020000000000000
    DisableFootSwitchDetection = 4503599627370496, // 0x0010000000000000
    DisableMemoryDump = 3489660928, // 0x00000000D0000000
    EnableRestartProcess = 32768, // 0x0000000000008000
    EnableKeepRunningHandler = 8192, // 0x0000000000002000
  }
  ...
  {
    Ok = 0,
    InvalidPacket = 2147549186, // 0x80010002
    InsufficientMemory = 2147549188, // 0x80010004
    Busy = 2147549194, // 0x8001000A
    NoDev = 2147549229, // 0x8001002D
  }

  public delegate void PadPlaybackCallback(
    int target,
    PS3TMAPI.SNRESULT res,
    PS3TMAPI.PadPlaybackResponse playbackResult,
    object userData);
  ...
  public delegate void PadCaptureCallback(
    int target,
    PS3TMAPI.SNRESULT res,
    PS3TMAPI.PadData[] padData,
    object userData);
  ...
  private delegate void CustomProtocolCallbackPriv(
    int target,
    PS3TMAPI.PS3Protocol protocol,
    IntPtr unmanagedBuf,
    uint length,
    IntPtr userData);

  public delegate void CustomProtocolCallback(
    int target,
    PS3TMAPI.PS3Protocol protocol,
    byte[] data,
    object userData);
  ...
  public enum FileServingEventFlag : ulong
  {
    ...
    Close = 4,
    Read = 8,
    Write = 16, // 0x0000000000000010
    Seek = 32, // 0x0000000000000020
    Delete = 64, // 0x0000000000000040
    Rename = 128, // 0x0000000000000080
    SetAttr = 256, // 0x0000000000000100
    GetAttr = 512, // 0x0000000000000200
    SetTime = 1024, // 0x0000000000000400
    MKDir = 2048, // 0x0000000000000800
    RMDir = 4096, // 0x0000000000001000
    OpenDir = 8192, // 0x0000000000002000
    CloseDir = 16384, // 0x0000000000004000
    ReadDir = 32768, // 0x0000000000008000
    Truncate = 65536, // 0x0000000000010000
    FGetAttr64 = 131072, // 0x0000000000020000
    GetAttr64 = 262144, // 0x0000000000040000
    All = GetAttr64 | FGetAttr64 | Truncate | ReadDir | CloseDir | OpenDir | RMDir | MKDir | SetTime | GetAttr | SetAttr | Rename | Delete | Seek | Write | Read | Close | Create, // 0x000000000007FFFD
  }
  ...
  public enum FileTransferNotificationType : uint
  {
    ...
    Pending = 5,
    Unknown = 6,
    RefreshList = 2147483648, // 0x80000000
  }
  ...
  public delegate void FTPEventCallback(
    int target,
    PS3TMAPI.SNRESULT res,
    PS3TMAPI.FTPNotification[] ftpNotifications,
    object userData);
  ...
  public enum FileTraceType
  {
    ...
    RMDir = 6,
    WidgetRMDir = 7,
    Rename = 14, // 0x0000000E
    WidgetRename = 15, // 0x0000000F
    Truncate = 18, // 0x00000012
    TruncateNoAlloc = 19, // 0x00000013
    Truncate2 = 20, // 0x00000014
    Truncate2NoInit = 21, // 0x00000015
    OpenDir = 24, // 0x00000018
    WidgetOpenDir = 25, // 0x00000019
    CHMod = 26, // 0x0000001A
    MkDir = 27, // 0x0000001B
    UTime = 29, // 0x0000001D
    Open = 33, // 0x00000021
    WidgetOpen = 34, // 0x00000022
    Close = 35, // 0x00000023
    CloseDir = 36, // 0x00000024
    FSync = 37, // 0x00000025
    ReadDir = 38, // 0x00000026
    FStat = 39, // 0x00000027
    FGetBlockSize = 40, // 0x00000028
    Read = 47, // 0x0000002F
    Write = 48, // 0x00000030
    GetDirEntries = 49, // 0x00000031
    ReadOffset = 50, // 0x00000032
    WriteOffset = 51, // 0x00000033
    FTruncate = 52, // 0x00000034
    FTruncateNoAlloc = 53, // 0x00000035
    LSeek = 56, // 0x00000038
    SetIOBuffer = 57, // 0x00000039
    OfflineEnd = 9999, // 0x0000270F
  }
  ...
  public delegate void FileTraceCallback(
    int target,
    PS3TMAPI.SNRESULT res,
    PS3TMAPI.FileTraceEvent fileTraceEvent,
    object userData);
  ...
  public enum TargetEventType : uint
  {
    ...
    ModuleStopped = 9,
    ModuleStoppedRemove = 10, // 0x0000000A
    PowerStatusChange = 11, // 0x0000000B
    TTYStreamAdded = 12, // 0x0000000C
    TTYStreamDeleted = 13, // 0x0000000D
    BDIsotransferStarted = 16, // 0x00000010
    BDIsotransferFinished = 17, // 0x00000011
    BDFormatStarted = 18, // 0x00000012
    BDFormatFinished = 19, // 0x00000013
    BDMountStarted = 20, // 0x00000014
    BDMountFinished = 21, // 0x00000015
    BDUnmountStarted = 22, // 0x00000016
    BDUnmountFinished = 23, // 0x00000017
    TargetSpecific = 2147483648, // 0x80000000
  }
  ...
  public enum TargetSpecificEventType : uint
  {
    ...
    ProcessKill = 2,
    ProcessExitSpawn = 3,
    PPUExcTrap = 16, // 0x00000010
    PPUExcPrevInt = 17, // 0x00000011
    PPUExcAlignment = 18, // 0x00000012
    PPUExcIllInst = 19, // 0x00000013
    PPUExcTextHtabMiss = 20, // 0x00000014
    PPUExcTextSlbMiss = 21, // 0x00000015
    PPUExcDataHtabMiss = 22, // 0x00000016
    PPUExcFloat = 23, // 0x00000017
    PPUExcDataSlbMiss = 24, // 0x00000018
    PPUExcDabrMatch = 25, // 0x00000019
    PPUExcStop = 26, // 0x0000001A
    PPUExcStopInit = 27, // 0x0000001B
    PPUExcDataMAT = 28, // 0x0000001C
    PPUThreadCreate = 32, // 0x00000020
    PPUThreadExit = 33, // 0x00000021
    SPUThreadStart = 48, // 0x00000030
    SPUThreadStop = 49, // 0x00000031
    SPUThreadStopInit = 50, // 0x00000032
    SPUThreadGroupDestroy = 51, // 0x00000033
    SPUThreadStopEx = 52, // 0x00000034
    PRXLoad = 64, // 0x00000040
    PRXUnload = 65, // 0x00000041
    DAInitialised = 96, // 0x00000060
    Footswitch = 112, // 0x00000070
    InstallPackageProgress = 128, // 0x00000080
    InstallPackagePath = 129, // 0x00000081
    CoreDumpComplete = 256, // 0x00000100
    CoreDumpStart = 257, // 0x00000101
    RawNotify = 4026531855, // 0xF000000F
  }
  ...
  public enum SPUThreadStopReason : uint
  {
    ...
    Error = 4,
    MFCFIR = 8,
    MFCSegment = 16, // 0x00000010
    MFCStorage = 32, // 0x00000020
    NoValue = 64, // 0x00000040
    StopCall = 256, // 0x00000100
    StopDCall = 512, // 0x00000200
    Halt = 1024, // 0x00000400
  }
  ...
  {
    TTY = 100, // 0x00000064
    Target = 101, // 0x00000065
    System = 102, // 0x00000066
    FTP = 103, // 0x00000067
    PadCapture = 104, // 0x00000068
    FileTrace = 105, // 0x00000069
    PadPlayback = 106, // 0x0000006A
    Server = 107, // 0x0000006B
  }

  private delegate void HandleEventCallbackPriv(
    int target,
    PS3TMAPI.EventType type,
    uint param,
    PS3TMAPI.SNRESULT result,
  ...
  public delegate void SearchTargetsCallback(
    string name,
    string type,
    PS3TMAPI.TCPIPConnectProperties ConnectInfo,
    object userData);

  private delegate void SearchTargetsCallbackPriv(
    IntPtr name,
    IntPtr type,
    IntPtr connectInfo,
    IntPtr userData);
  ...
  private class SearchForTargetsCallbackHandler
  {
    ...
    public static void SearchForTargetsCallback(
      IntPtr namePtr,
      IntPtr typePtr,
      IntPtr connectInfoPtr,
      IntPtr userDataPtr)
    {
